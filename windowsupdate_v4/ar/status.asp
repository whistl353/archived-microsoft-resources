...
<img source="/shared/images/complete_icon.gif" class="icon32" alt="تم الإجراء بنجاح." /><span class="sys-font-heading3 sys-rhp-color-title">تمت عملية التثبيت</span><br /><br />
		<span>تم تثبيت التحديثات التالية بنجاح:</span><br /><br />

		<br />
		<a href="javascript:parent.fnDisplayHistory();" class="sys-link-normal">عرض محفوظات التثبيت</a><br /><br />
	</body>
</html>