...
function sortlanguage(selectname,formname){
	...
	iTxt[0]="«·⁄—»Ì…" + "@" + "ar|1256"
	//iTxt[1]="œ⁄„ ··€… «·⁄—»Ì…" + "@" + "en_arabic|1252"
	iTxt[1]=" —ﬂÌ" + "@" + "tr|1254"
	iTxt[2]="’Ì‰Ì „»”¯ÿ " + "@" + "zhcn|936"
	iTxt[3]="’Ì‰Ì  ﬁ·ÌœÌ " + "@" + "zhtw|950"
	iTxt[4]="«· ‘ÌﬂÌ…" + "@" + "cs|1250"
	iTxt[5]="«·œ«‰„«—ﬂÌ…" + "@" + "da|1252"
	iTxt[6]="«·ÂÊ·‰œÌ…" + "@" + "nl|1252"
	iTxt[7]="«·≈‰ﬂ·Ì“Ì…" + "@" + "en|1252"
	iTxt[8]="«·›‰·‰œÌ…" + "@" + "fi|1252"
	iTxt[9]="«·›—‰”Ì…" + "@" + "fr|1252"
	iTxt[10]="«·√·„«‰Ì…" + "@" + "de|1252"
	iTxt[11]="«·ÌÊ‰«‰Ì…" + "@" + "el|1253"
	//iTxt[12]="IBM ÌÊ‰«Ì" + "@" + "el_ibm|869"
	iTxt[12]="”ÊÌœÌ" + "@" + "sv|1252"
	iTxt[13]="«·⁄»—Ì…" + "@" + "he|1255"
	//iTxt[14]="œ⁄„ ··€… «·⁄»—Ì…" + "@" + "en_hebrew|1252"
	iTxt[14]="«”»«‰Ì" + "@" + "es|1252"
	iTxt[15]="«·Â‰€«—Ì…" + "@" + "hu|1250"
	iTxt[16]="«·≈Ìÿ«·Ì…" + "@" + "it|1252"
	iTxt[17]="«·Ì«»«‰Ì…" + "@" + "ja|932"
	iTxt[18]="NEC Ì«»«‰Ì" + "@" + "nec|932"
	iTxt[19]="«·ﬂÊ—Ì…" + "@" + "ko|949"
	iTxt[20]="«·‰—ÊÌÃÌ…" + "@" + "no|1252"
	iTxt[21]="«·»Ê·Ê‰Ì…" + "@" + "pl|1250"
	iTxt[22]="»— €«·Ì («·»—«“Ì·)" + "@" + "ptbr|1252"
	iTxt[23]="»— €«·Ì (ﬁÌ«”Ì)" + "@" + "pt|1252"
	iTxt[24]="—Ê”Ì" + "@" + "ru|1251"
	//iTxt[25]="”·Ê›«ﬂÌ" + "@" + "sk|1250"
	//iTxt[26]="”·Ê›Ì‰Ì" + "@" + "sl|1250"
	
	
	//iTxt[29]="œ⁄„ ··€… «· «Ì·«‰œÌ…" + "@" + "en_thai|1252"
...
<table cellpadding="0" cellspacing="0" border="0">
	...
	<tr><td class="8pt sys-font-body sys-color-body">«·»ÕÀ ⁄‰  ÕœÌÀ«  ·‰Ÿ«„  ‘€Ì· Windows. Õœœ „‰ «·„⁄«ÌÌ— √œ‰«Â À„ «‰ﬁ— ›Êﬁ <b>«·»ÕÀ</b>.</td></tr>
	...
	<tr><td>
		...
		<table cellpadding="0" cellspacing="0" leftmargin="0" height="100%" class="tblborder sys-table-color-border sys-table-cell-bgcolor2" border="0">
			<tr><td>
				<table cellpadding="0" cellspacing="0" border="0" class="innertbl" height="100%"  style="padding-right:10px" >
					<tr><td class="8pt sys-font-body sys-color-body" height="10em"><br></td></tr>
					<tr><td class="8pt sys-font-body sys-color-body">‰Ÿ«„  ‘€Ì·:</td></tr>
...
<option value='ver_platform_win32_nt.5.2.amd64.ver_nt_workstation..3790..'><pre>Windows XP x64 Edition Family</pre></option>
					...
					<tr>
						...
						<!--	<select NAME="selLanguage" ID="selLanguage">								<option VALUE="ar|1256">«·⁄—»Ì…</option>								<option VALUE="en_arabic|1252">œ⁄„ ··€… «·⁄—»Ì…</option>								<option VALUE="zhcn|936">’Ì‰Ì „»”¯ÿ </option>								<option VALUE="zhtw|950">’Ì‰Ì  ﬁ·ÌœÌ </option>								<option VALUE="cs|1250">«· ‘ÌﬂÌ…</option>								<option VALUE="da|1252">«·œ«‰„«—ﬂÌ…</option>								<option VALUE="nl|1252">«·ÂÊ·‰œÌ…</option>								<option VALUE="en|1252" selected>«·≈‰ﬂ·Ì“Ì…</option>								<option VALUE="fi|1252">«·›‰·‰œÌ…</option>								<option VALUE="fr|1252">«·›—‰”Ì…</option>								<option VALUE="de|1252">«·√·„«‰Ì…</option>								<option VALUE="el|1253">«·ÌÊ‰«‰Ì…</option>								<option VALUE="el_ibm|869">IBM ÌÊ‰«Ì</option>								<option VALUE="he|1255">«·⁄»—Ì…</option>								<option VALUE="en_hebrew|1252">œ⁄„ ··€… «·⁄»—Ì…</option>								<option VALUE="hu|1250">«·Â‰€«—Ì…</option>								<option VALUE="it|1252">«·≈Ìÿ«·Ì…</option>								<option VALUE="ja|932">«·Ì«»«‰Ì…</option>								<option VALUE="nec|932">NEC Ì«»«‰Ì</option>								<option VALUE="ko|949">«·ﬂÊ—Ì…</option>								<option VALUE="no|1252">«·‰—ÊÌÃÌ…</option>								<option VALUE="pl|1250">«·»Ê·Ê‰Ì…</option>								<option VALUE="ptbr|1252">»— €«·Ì («·»—«“Ì·)</option>								<option VALUE="pt|1252">»— €«·Ì (ﬁÌ«”Ì)</option>								<option VALUE="ru|1251">—Ê”Ì</option>								<option VALUE="sk|1250">”·Ê›«ﬂÌ</option>								<option VALUE="sl|1250">”·Ê›Ì‰Ì</option>								<option VALUE="es|1252">«”»«‰Ì</option>								<option VALUE="sv|1252">”ÊÌœÌ</option>								<option VALUE="en_thai|1252">œ⁄„ ··€… «· «Ì·«‰œÌ…</option>								<option VALUE="tr|1254"> —ﬂÌ</option>							</select>-->
						</td>
					</tr>
					<tr><td class="8pt sys-font-body sys-color-body" height="10em"></td></tr>
					<tr><td valign="top"> <a onclick="showadv();return false;" class="10pt sys-font-heading4 sys-link-normal" href="/" onmouseOver="overchangeimage();" onmouseOut="outchangeimage();">ŒÌ«—«  «·»ÕÀ «·„ ﬁœ„… <span id="exco" name="exco"><img id="expando" name="expando" src="/catalog/images/expando_primary_down_normal.gif"></span></a>
					<tr><td class="8pt sys-font-body sys-color-body" height="10em"></td></tr>
					<tr><td>
						<span id="advopt" name="advopt" class="advspan sys-table-color-border sys-rhp-bgcolor sys-table-cell-bgcolor1" style="display:none">
							<table CELLPADDING="0" CELLSPACING="0" BORDER="0" style="padding-left:5px;padding-right:5px">
								<tr><td class="8pt sys-font-body sys-color-body"> «—ÌŒ «·‰‘— ≈·Ï ÊÌ»:</td></tr>
								<tr><td height="2"><img src="/catalog/images/ts.gif" HEIGHT="2" WIDTH="1"></td></tr>
								<tr>
									<td class="8pt sys-font-body sys-color-body">
										<select NAME="selPostedDate" ID="selPostedDate">
											<option value="0">ﬂ«›… «· «—ÌŒ «·„‰‘Ê—</option>
											<option value="7">«·√”»Ê⁄ «·”«»ﬁ</option>
											<option value="14">«·√”»Ê⁄«‰ «·”«»ﬁ«‰</option>
											<option value="30">«·‘Â— «·”«»ﬁ</option>
											<option value="60">‘Â—«‰ ”«»ﬁ«‰</option>
											<option value="180">6 √‘Â— ”«»ﬁ…</option>
											<option value="365">«·⁄«„ «·”«»ﬁ</option>
										</select>
									</td>
								</tr>
								<tr><td height="10em"></td></tr>
								<tr><td class="8pt sys-font-body sys-color-body"><nobr> Õ ÊÌ ⁄·Ï Â–Â «·ﬂ·„« :&nbsp;&nbsp;
																<a class="sys-link-normal" href="javascript:goLearnKeywords()">√Œ»—‰Ì ⁄‰ «” Œœ«„ «·ﬂ·„«  · ÕœÌœ „Ã«· ⁄„·Ì… «·»ÕÀ</a></nobr></td></tr>
								<tr><td height="2"><img src="/catalog/images/ts.gif" HEIGHT="2" WIDTH="1"></td></tr>
								<tr>
									<td class="8pt sys-font-body sys-color-body">
								...
								<tr><td height="10em"></td></tr>
								<tr><td class="8pt sys-font-body sys-color-body">√‰Ê«⁄ «· ÕœÌÀ:</td></tr>
								<tr><td class="8pt sys-font-body sys-color-body">
										<table width="100%">
											<tr>
											
														</tr><tr>
													<td class=8pt sys-font-body sys-color-body valign=top><table><tr><td width="20" valign=top><INPUT type=checkbox id=check0 name=check0 value='Critical Updates' checked></td><td class=8pt sys-font-body sys-color-body ><label for=check0>&#1575;&#1604;&#1571;&#1587;&#1575;&#1587;&#1610;&#1577; &#1608;&#1581;&#1586;&#1605; &#1575;&#1604;&#1582;&#1583;&#1605;&#1575;&#1578;</label></td></tr></table></td><td class=8pt sys-font-body sys-color-body valign=top><table><tr><td width="20" valign=top><INPUT type=checkbox id=check1 name=check1 value='Advanced Security Updates' checked></td><td class=8pt sys-font-body sys-color-body ><label for=check1>&#1578;&#1581;&#1583;&#1610;&#1579; &#1582;&#1583;&#1605;&#1575;&#1578; &#1575;&#1604;&#1578;&#1579;&#1576;&#1610;&#1578; &#1593;&#1606; &#1576;&#1593;&#1583;</label></td></tr></table></td>
														</tr><tr>
													<td class=8pt sys-font-body sys-color-body valign=top><table><tr><td width="20" valign=top><INPUT type=checkbox id=check2 name=check2 value='Internet and Multimedia Updates' checked></td><td class=8pt sys-font-body sys-color-body ><label for=check2>&#1578;&#1581;&#1583;&#1610;&#1579;&#1575;&#1578; &#1573;&#1606;&#1578;&#1585;&#1606;&#1578; &#1608;&#1575;&#1604;&#1608;&#1587;&#1575;&#1574;&#1591; &#1575;&#1604;&#1605;&#1578;&#1593;&#1583;&#1583;&#1577;</label></td></tr></table></td><td class=8pt sys-font-body sys-color-body valign=top><table><tr><td width="20" valign=top><INPUT type=checkbox id=check3 name=check3 value='Multi-Language Features' checked></td><td class=8pt sys-font-body sys-color-body ><label for=check3>&#1605;&#1586;&#1575;&#1610;&#1575; &#1578;&#1593;&#1583;&#1583; &#1575;&#1604;&#1604;&#1594;&#1575;&#1578;</label></td></tr></table></td>
														</tr><tr>
													<td class=8pt sys-font-body sys-color-body valign=top><table><tr><td width="20" valign=top><INPUT type=checkbox id=check4 name=check4 value='Recommended Updates' checked></td><td class=8pt sys-font-body sys-color-body ><label for=check4>&#1578;&#1581;&#1583;&#1610;&#1579;&#1575;&#1578; &#1605;&#1587;&#1578;&#1581;&#1587;&#1606;&#1577;</label></td></tr></table></td>
											</tr>
										</table></td>
								</tr>
							</table>
			...
			<tr><td align="left" class="osbutton sys-table-header-bgcolor1">
				
				<button onclick="javascript:Docheck();" onresize="document.recalc('true')" style="width:expression(buttonspan.offsetWidth + 10)" id="button1" name="button1"><span id="buttonspan" name="buttonspan">«·»ÕÀ</span></button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
			</tr>
		</table>
