	...
	<script language="JScript">
		...
		aRows = eSortTable.rows
			...
			for (i=0;i<buttonarray.length;i++){
				if(buttonarray[i].innerHTML == "Pøidat")
	...
	<tr><td height="1"><span class="8pt sys-font-body sys-color-body" id="addspan" name="addspan" style="visibility:hidden;height=1;overflow;hidden">Pøidat</span><span class="8pt sys-font-body sys-color-body" name="removespan" id="removespan" style="visibility:hidden;height=1;overflow;hidden">Odebrat</span></td></tr>
			...
			<td valign="top" height="40em">
				<div>
					<div valign="middle" style="background-color:#Ffffcc;padding-top:3;padding-bottom:5;padding-left:10">
						...
						<span class="title sys-font-heading3 sys-rhp-color-title">Košík aktualizací</span></nobr>
					</div>
				</div></td>
		</tr>
		<tr>
			<td valign="top">
				<div name="reviewandinstall"id="reviewandinstall">
					<div   class="8pt sys-font-body sys-color-body"><b>Prohlížet a stahovat vybrané aktualizace</b></div>
					<div  class="8pt sys-font-body sys-color-body"><!--<img src="/catalog/images/ts.gif" height="1" width="56">-->Zadejte požadované umístìní souborù ke stažení a potom klepnìte na tlaèítko <b>Stáhnout</b>. Chcete-li odebrat položku z košíku, klepnìte na tlaèítko <b>Odebrat</b>.</div>
				</div>
				<div name="noreviewandinstall"id="noreviewandinstall" style="display:none">
					<div   class="8pt sys-font-body sys-color-body"><b><b>V košíku nejsou žádné aktualizace.</b></b></div>
					<div  class="8pt sys-font-body sys-color-body"><!--<img src="/catalog/images/ts.gif" height="1" width="56">-->Chcete-li vybrat aktualizace pro stažení, klepnìte na možnost <b>Vítá vás Katalog systému Windows Update</b> nebo odpovídající kategorii a zadejte kritéria vyhledávání.</div>
				</div>
			</td>
		</tr>
		<tr>
			...
			<form name="txtform" id="textform" action="downloadbasket.asp" onsubmit="return downloadnow();">
				<div>
					<div class="8pt sys-font-body sys-color-body">&nbsp;<br><nobr>Zadejte nebo vyhledejte vybrané umístìní pro stahování:</nobr></div>
					<div class="10pt sys-font-heading4">
						...
						<button onresize="document.recalc('true')" style="width:expression(browsespan.offsetWidth + 10)" onClick="javascript:goBrowse()" id="browseb" name="browseb">
							<span id="browsespan" name="browsespan">Procházet…</span></button></nobr>
					...
					<table cellpadding="0" cellspacing="0" border="0">
						<tr>
							<td class="8pt sys-font-body sys-color-body">
								...
								<button id="dnow" name="dnow" type="submit" style="width:expression(downspan.offsetWidth + 10)" disabled><span name="downspan" id="downspan">Stáhnout</span></button>
								<br>
							</td>
						</tr>
					</table>
		...
		<tr>
			<td class="resultsBasketBar sys-table-header-bgcolor1 sys-table-color-border sys-toppane-header-color" valign="top">
				<span id="eBasketCalculating">Celkem (vèetnì pøedpokladù):</span> <span id="eBasketStats"></span>
			</td>
		</tr>
		<tr>
			<td height="100%">
				<div id="eUpdatesContainer" class="eUpdatesContainer sys-table-color-border sys-table-cell-bgcolor2">
					...
					<div id="noupdates" class="8pt sys-font-body sys-color-body" style="display:none">
						...
						<p>
						<center>
						<b>V košíku nejsou žádné aktualizace.</b>
						</center>
					</div>
...
//fnSortTable(2,false)
	...
	var Minute="minuta";
	var Minutes="minut";
	var DownloadSize="Velikost ke stažení:"
	var MB="MB"
	var KB="kB"
	var basketarray=parent.frames["eTOC"].sBasketString.split(",");
...
//alert(controlxml)
		...
		if(bstrStartFolder == "" || false == bstrStartFolder) {
			var badpath="Systém Windows Update nemùže položky stáhnout do zadané složky. Složka neexistuje nebo nemáte povolení pøidávat do ní položky. Zkontrolujte, zda jste zadali správnou cestu ke složce nebo zadejte jiné umístìní.";
			alert(badpath);
			return false;
		}
	...
	function goBrowse() {
		...
		if(pbstrFolder.length >=50){
			...
			sAlert = 'Cesta pro stažení musí obsahovat ménì než 50 znakù. Cesta, kterou jste zadali, je: \n\r' + pbstrFolder + "\n\r\n\r" + 'Zadejte nebo pøejdìte k cestì pro stažení, jejíž délka je menší než 50 znakù.'
			alert(sAlert)
		}
