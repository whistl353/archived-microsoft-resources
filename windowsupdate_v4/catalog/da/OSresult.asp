...
<table cellpadding="0" cellspacing="0" border="0">
	...
	<tr><td class="8pt sys-font-body sys-color-body" valign="top">
			<b>Din søgning returnerede <span id="totalitems"></span>&nbsp; resultater</b> <br/>Vælg fra listen nedenfor for at se de opdateringer, der er fundet i hver kategori.</td>
	</tr>
	...
	<tr><td id="info" class="8pt sys-font-body sys-color-body" align="center" valign="bottom">
		<img src="/catalog/images/ts.gif" width="1" height="100"><b>Vælg en kategori på listen ovenfor.</b></td>
	</tr>
	...
	<tr><td id="gotobasket" class="8pt sys-font-body sys-color-body" align="left" valign="top" style="visibility:hidden">
		<table cellpadding="0" cellspacing="0" border="0" width="100%">
			...
			<tr>
				<td class="8pt sys-font-body sys-color-body" valign="top" width="50%"><a class="sys-link-normal" href="/" onclick="javascript:gobasket();return false;"><img alt="Ikon med grøn pil, der angiver en opgave eller handling." src="/catalog/images/green_arrow.gif" border="0"  style="padding-bottom:-5px;" align=absmiddle WIDTH="30" HEIGHT="25">Gå til Overførselskurv</a></td>
				<td class="8pt sys-font-body sys-color-body" align="right">Samlede emner i overførselskurven:<span id="eViewBasket"> </span> <span id="eBasketStats"></span> </td>
			</tr>
			<tr>
				<td colspan="2" HEIGHT="6"><img src="/catalog/images/ts.gif" HEIGHT="10"></td>
			</tr>
			<tr>
				<td colspan="2" class="8pt sys-font-body sys-color-body" valign="top" align='right'>Sorter efter: 
					<select onchange="sortitems()" name="sortselect" id="sortselect">
						<option value="0">Titel</option>
						<option value="2">Dato for udgivelse</option>
					</select>
				</td>
