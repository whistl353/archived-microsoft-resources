	...
	<script language="JScript">
		...
		aRows = eSortTable.rows
			...
			for (i=0;i<buttonarray.length;i++){
				if(buttonarray[i].innerHTML == "Hinzufügen")
					buttonarray[i].style.width = addlength
				if(buttonarray[i].innerHTML == "Entfernen")
...
<table cellspacing="0" cellpadding="0" border="0">
	<tbody>
	<tr><td height="1"><span class="8pt sys-font-body sys-color-body" id="addspan" name="addspan" style="visibility:hidden;height=1;overflow;hidden">Hinzufügen</span><span class="8pt sys-font-body sys-color-body" name="removespan" id="removespan" style="visibility:hidden;height=1;overflow;hidden">Entfernen</span></td></tr>
		<tr>
			<td valign="top" height="40em">
				<div>
					<div valign="middle" style="background-color:#Ffffcc;padding-top:3;padding-bottom:5;padding-left:10">
						...
						<span class="title sys-font-heading3 sys-rhp-color-title">Downloadwarenkorb</span></nobr>
					</div>
				</div></td>
		</tr>
		<tr>
			<td valign="top">
				<div name="reviewandinstall"id="reviewandinstall">
					<div   class="8pt sys-font-body sys-color-body"><b>Ausgewählte Updates überprüfen und übertragen</b></div>
					<div  class="8pt sys-font-body sys-color-body"><!--<img src="/catalog/images/ts.gif" height="1" width="56">-->Geben Sie den gewünschten Downloadpfad an, und klicken Sie dann auf <b>Jetzt downloaden</b>. Klicken Sie auf <b>Entfernen</b>, um ein Update aus dem Warenkorb zu entfernen.</div>
				</div>
				<div name="noreviewandinstall"id="noreviewandinstall" style="display:none">
					<div   class="8pt sys-font-body sys-color-body"><b><b>Es sind keine Updates im Warenkorb.</b></b></div>
					<div  class="8pt sys-font-body sys-color-body"><!--<img src="/catalog/images/ts.gif" height="1" width="56">-->Klicken Sie auf <b>Willkommen</b> oder auf eine der folgenden Kategorien, und legen Sie Ihre Suchkriterien fest, um Updates zum Downloaden auszuwählen.</div>
				</div>
			</td>
		</tr>
		<tr>
			...
			<form name="txtform" id="textform" action="downloadbasket.asp" onsubmit="return downloadnow();">
				<div>
					<div class="8pt sys-font-body sys-color-body">&nbsp;<br><nobr>Geben Sie den Pfad zu den gewünschten Updates an bzw. klicken Sie auf <b>Durchsuchen</b>:</nobr></div>
					<div class="10pt sys-font-heading4">
						...
						<button onresize="document.recalc('true')" style="width:expression(browsespan.offsetWidth + 10)" onClick="javascript:goBrowse()" id="browseb" name="browseb">
							<span id="browsespan" name="browsespan">Durchsuchen...</span></button></nobr>
					...
					<table cellpadding="0" cellspacing="0" border="0">
						<tr>
							<td class="8pt sys-font-body sys-color-body">
								...
								<button id="dnow" name="dnow" type="submit" style="width:expression(downspan.offsetWidth + 10)" disabled><span name="downspan" id="downspan">Jetzt downloaden</span></button>
								<br>
							</td>
						</tr>
					</table>
		...
		<tr>
			<td class="resultsBasketBar sys-table-header-bgcolor1 sys-table-color-border sys-toppane-header-color" valign="top">
				<span id="eBasketCalculating">Gesamt (einschließlich Anforderungen):</span> <span id="eBasketStats"></span>
			</td>
		</tr>
		<tr>
			<td height="100%">
				<div id="eUpdatesContainer" class="eUpdatesContainer sys-table-color-border sys-table-cell-bgcolor2">
					...
					<div id="noupdates" class="8pt sys-font-body sys-color-body" style="display:none">
						...
						<p>
						<center>
						<b>Es sind keine Updates im Warenkorb.</b>
						</center>
					</div>
...
//fnSortTable(2,false)
	...
	var Minute="Minute";
	var Minutes="Minuten";
	var DownloadSize="Downloadgröße:"
	var MB="MB"
	var KB="KB"
	var basketarray=parent.frames["eTOC"].sBasketString.split(",");
...
//alert(controlxml)
		...
		if(bstrStartFolder == "" || false == bstrStartFolder) {
			var badpath="Windows Update kann keine Dateien in den angegebenen Ordner downloaden. Entweder der Ordner existiert nicht, oder Sie besitzen nicht die Berechtigung zum Downloaden in diesen Ordner. Stellen Sie sicher, dass Sie den korrekten Pfad angegebenen haben, oder geben Sie einen anderen Pfad an.";
			alert(badpath);
			return false;
		}
	...
	function goBrowse() {
		...
		if(pbstrFolder.length >=50){
			...
			sAlert = 'Der Downloadpfad muss weniger als 50 Zeichen enthalten. Der angegebene Pfad enthält: \n\r' + pbstrFolder + "\n\r\n\r" + 'Geben Sie den Downloadpfad ein. Der Pfad muss weniger als 50 Zeichen lang sein.'
			alert(sAlert)
		}
