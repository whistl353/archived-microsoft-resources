...
function Docheck(){
	...
	if (OSfind.selOS.value == 0){
		alert("Wählen Sie ein Betriebssystem aus.");
		return false;
	}
	for (i=0;i<=num;i++){
	...
	if (selected == 0){
		alert("Wählen Sie mindestens einen Updatetyp aus.");
		return false;
	}
	else{
...
<table cellpadding="0" cellspacing="0" border="0">
	...
	<tr><td class="8pt sys-font-body sys-color-body">Suchen Sie nach Updates für Windows-Betriebssysteme. Wählen Sie eine der unten angegebenen Suchkriterien, und klicken Sie dann auf <b>Suchen</b>.</td></tr>
		...
		<table cellpadding="0" cellspacing="0" leftmargin="0" height="100%" class="tblborder sys-table-color-border sys-table-cell-bgcolor2" border="0">
			<tr><td>
				<table cellpadding="0" cellspacing="0" border="0" class="innertbl" height="100%" >
					...
					<tr><td class="8pt sys-font-body sys-color-body">Betriebssystem:</td></tr>
...
<option value='ver_platform_win32_nt.5.2.amd64.ver_nt_workstation..3790..'><pre>Windows XP x64 Edition Family</pre></option>
					...
					<tr><td class="8pt sys-font-body sys-color-body">Sprache: </td></tr>
					...
					<tr>
						...
						<!--	<select NAME="selLanguage" ID="selLanguage">								<option VALUE="ar|1256">Arabisch</option>								<option VALUE="en_arabic|1252">Arabisch aktiviert</option>								<option VALUE="zhcn|936">Chinesisch, vereinfacht</option>								<option VALUE="zhtw|950">Chinesisch, traditionell</option>								<option VALUE="cs|1250">Tschechisch</option>								<option VALUE="da|1252">Dänisch</option>								<option VALUE="nl|1252">Niederländisch</option>								<option VALUE="en|1252" selected>Englisch</option>								<option VALUE="fi|1252">Finnisch</option>								<option VALUE="fr|1252">Französisch</option>								<option VALUE="de|1252">Deutsch</option>								<option VALUE="el|1253">Griechisch</option>								<option VALUE="el_ibm|869">Griechisch-IBM</option>								<option VALUE="he|1255">Hebräisch</option>								<option VALUE="en_hebrew|1252">Aktiviert für Hebräisch</option>								<option VALUE="hu|1250">Ungarisch</option>								<option VALUE="it|1252">Italienisch</option>								<option VALUE="ja|932">Japanisch</option>								<option VALUE="nec|932">Japanisch-NEC</option>								<option VALUE="ko|949">Koreanisch</option>								<option VALUE="no|1252">Norwegisch</option>								<option VALUE="pl|1250">Polnisch</option>								<option VALUE="ptbr|1252">Portugiesisch (Brasilien)</option>								<option VALUE="pt|1252">Portugiesisch (Standard)</option>								<option VALUE="ru|1251">Russisch</option>								<option VALUE="sk|1250">Slowakisch</option>								<option VALUE="sl|1250">Slowenisch</option>								<option VALUE="es|1252">Spanisch</option>								<option VALUE="sv|1252">Schwedisch</option>								<option VALUE="en_thai|1252">Aktiviert für Thailändisch</option>								<option VALUE="tr|1254">Türkisch</option>							</select>-->
						</td>
					</tr>
					<tr><td class="8pt sys-font-body sys-color-body" height="10em"></td></tr>
					<tr><td valign="top"> <a onclick="showadv();return false;" class="10pt sys-font-heading4 sys-link-normal" href="/" onmouseOver="overchangeimage();" onmouseOut="outchangeimage();">Erweiterte Suchoptionen <span id="exco" name="exco"><img id="expando" name="expando" src="/catalog/images/expando_primary_down_normal.gif"></span></a>
					<tr><td class="8pt sys-font-body sys-color-body" height="10em"></td></tr>
					<tr><td>
						<span id="advopt" name="advopt" class="advspan sys-table-color-border sys-rhp-bgcolor sys-table-cell-bgcolor1" style="display:none">
							<table CELLPADDING="0" CELLSPACING="0" BORDER="0" style="padding-left:5px;padding-right:5px">
								<tr><td class="8pt sys-font-body sys-color-body">Im Web veröffentlicht am:</td></tr>
								<tr><td height="2"><img src="/catalog/images/ts.gif" HEIGHT="2" WIDTH="1"></td></tr>
								<tr>
									<td class="8pt sys-font-body sys-color-body">
										<select NAME="selPostedDate" ID="selPostedDate">
											<option value="0">Alle Bereitstellungsdaten</option>
											<option value="7">Vergangene Woche</option>
											<option value="14">Vergangenen zwei Wochen</option>
											<option value="30">Vergangenen Monat</option>
											<option value="60">Vergangenen 2 Monate</option>
											<option value="180">Vergangenen 6 Monate</option>
											<option value="365">Letztes Jahr</option>
										</select>
									</td>
								</tr>
								<tr><td height="10em"></td></tr>
								<tr><td class="8pt sys-font-body sys-color-body"><nobr>Enthält folgende Wörter:&nbsp;&nbsp;
																<a class="sys-link-normal" href="javascript:goLearnKeywords()">Weitere Informationen über die Verwendung von Worten zum Einschränken der Suche</a></nobr></td></tr>
								<tr><td height="2"><img src="/catalog/images/ts.gif" HEIGHT="2" WIDTH="1"></td></tr>
								<tr>
									<td class="8pt sys-font-body sys-color-body">
								...
								<tr><td height="10em"></td></tr>
								<tr><td class="8pt sys-font-body sys-color-body">Updatetypen:</td></tr>
								<tr><td class="8pt sys-font-body sys-color-body">
										<table width="100%">
											<tr>
											
														</tr><tr>
													<td class=8pt sys-font-body sys-color-body valign=top><table><tr><td width="20" valign=top><INPUT type=checkbox id=check0 name=check0 value='Critical Updates' checked></td><td class=8pt sys-font-body sys-color-body ><label for=check0>Wichtige Aktualisierungen und Service Packs</label></td></tr></table></td><td class=8pt sys-font-body sys-color-body valign=top><table><tr><td width="20" valign=top><INPUT type=checkbox id=check1 name=check1 value='Advanced Security Updates' checked></td><td class=8pt sys-font-body sys-color-body ><label for=check1>Erweiterte Sicherheitsupdates</label></td></tr></table></td>
														</tr><tr>
													<td class=8pt sys-font-body sys-color-body valign=top><table><tr><td width="20" valign=top><INPUT type=checkbox id=check2 name=check2 value='Additional Windows Downloads' checked></td><td class=8pt sys-font-body sys-color-body ><label for=check2>Weitere Windows-Downloads</label></td></tr></table></td><td class=8pt sys-font-body sys-color-body valign=top><table><tr><td width="20" valign=top><INPUT type=checkbox id=check3 name=check3 value='Internet and Multimedia Updates' checked></td><td class=8pt sys-font-body sys-color-body ><label for=check3>Updates f&#252;r Internet und Multimedia</label></td></tr></table></td>
														</tr><tr>
													<td class=8pt sys-font-body sys-color-body valign=top><table><tr><td width="20" valign=top><INPUT type=checkbox id=check4 name=check4 value='Multi-Language Features' checked></td><td class=8pt sys-font-body sys-color-body ><label for=check4>Mehrsprachigkeitsfeatures</label></td></tr></table></td><td class=8pt sys-font-body sys-color-body valign=top><table><tr><td width="20" valign=top><INPUT type=checkbox id=check5 name=check5 value='Recommended Updates' checked></td><td class=8pt sys-font-body sys-color-body ><label for=check5>Empfohlene Updates</label></td></tr></table></td>
											</tr>
										</table></td>
								</tr>
							</table>
			...
			<tr><td align="right" class="osbutton sys-table-header-bgcolor1">
				...
				<button onclick="javascript:Docheck();" onresize="document.recalc('true')" style="width:expression(buttonspan.offsetWidth + 10)" id="button1" name="button1"><span id="buttonspan" name="buttonspan">Suchen</span></button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
			</tr>
		</table>
