...
<table cellpadding="0" cellspacing="0" border="0">
	...
	<tr><td class="8pt sys-font-body sys-color-body" valign="top">
			<b>Η αναζήτησή σας επέστρεψε  <span id="totalitems"></span>&nbsp; αποτελέσματα</b> <br/>Επιλέξτε από την παρακάτω λίστα, για να δείτε τις ενημερωμένες εκδόσεις που βρέθηκαν σε κάθε κατηγορία.</td>
	</tr>
	...
	<tr><td id="info" class="8pt sys-font-body sys-color-body" align="center" valign="bottom">
		<img src="/catalog/images/ts.gif" width="1" height="100"><b>Επιλέξτε μια κατηγορία από την παραπάνω λίστα.</b></td>
	</tr>
	...
	<tr><td id="gotobasket" class="8pt sys-font-body sys-color-body" align="left" valign="top" style="visibility:hidden">
		<table cellpadding="0" cellspacing="0" border="0" width="100%">
			...
			<tr>
				<td class="8pt sys-font-body sys-color-body" valign="top" width="50%"><a class="sys-link-normal" href="/" onclick="javascript:gobasket();return false;"><img alt="Εικονίδιο πράσινου βέλους που δηλώνει μια εργασία ή ενέργεια." src="/catalog/images/green_arrow.gif" border="0"  style="padding-bottom:-5px;" align=absmiddle WIDTH="30" HEIGHT="25">Μετάβαση στο καλάθι αρχείων για λήψη</a></td>
				<td class="8pt sys-font-body sys-color-body" align="right">Σύνολο στοιχείων στο καλάθι για αρχεία λήψης:<span id="eViewBasket"> </span> <span id="eBasketStats"></span> </td>
			</tr>
			<tr>
				<td colspan="2" HEIGHT="6"><img src="/catalog/images/ts.gif" HEIGHT="10"></td>
			</tr>
			<tr>
				<td colspan="2" class="8pt sys-font-body sys-color-body" valign="top" align='right'>Ταξινόμηση κατά: 
					<select onchange="sortitems()" name="sortselect" id="sortselect">
						<option value="0">Τίτλος</option>
						<option value="2">Ημερομηνία δημοσίευσης</option>
					</select>
				</td>
