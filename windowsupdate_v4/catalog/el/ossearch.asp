...
function Docheck(){
	...
	if (OSfind.selOS.value == 0){
		alert("Επιλέξτε ένα λειτουργικό σύστημα");
		return false;
	}
	for (i=0;i<=num;i++){
	...
	if (selected == 0){
		alert("Επιλέξτε έναν τουλάχιστον τύπο ενημερωμένης έκδοσης.");
		return false;
	}
	else{
...
<table cellpadding="0" cellspacing="0" border="0">
	...
	<tr><td class="8pt sys-font-body sys-color-body">Βρείτε ενημερωμένες εκδόσεις για τα λειτουργικά συστήματα των Windows. Επιλέξτε από τα παρακάτω κριτήρια και στη συνέχεια κάντε κλικ στο κουμπί <b>Αναζήτηση</b>.</td></tr>
		...
		<table cellpadding="0" cellspacing="0" leftmargin="0" height="100%" class="tblborder sys-table-color-border sys-table-cell-bgcolor2" border="0">
			<tr><td>
				<table cellpadding="0" cellspacing="0" border="0" class="innertbl" height="100%" >
					...
					<tr><td class="8pt sys-font-body sys-color-body">Λειτουργικό σύστημα:</td></tr>
...
<option value='ver_platform_win32_nt.5.2.amd64.ver_nt_workstation..3790..'><pre>Windows XP x64 Edition Family</pre></option>
					...
					<tr><td class="8pt sys-font-body sys-color-body">Γλώσσα: </td></tr>
					...
					<tr>
						...
						<!--	<select NAME="selLanguage" ID="selLanguage">								<option VALUE="ar|1256">Αραβικά</option>								<option VALUE="en_arabic|1252">Ενεργοποίηση αραβικών</option>								<option VALUE="zhcn|936">Απλοποιημένα κινέζικα </option>								<option VALUE="zhtw|950">Παραδοσιακά κινέζικα </option>								<option VALUE="cs|1250">Τσεχικά</option>								<option VALUE="da|1252">Δανικά</option>								<option VALUE="nl|1252">Ολλανδικά</option>								<option VALUE="en|1252" selected>Αγγλικά</option>								<option VALUE="fi|1252">Φινλανδικά</option>								<option VALUE="fr|1252">Γαλλικά</option>								<option VALUE="de|1252">Γερμανικά</option>								<option VALUE="el|1253">Ελληνικά</option>								<option VALUE="el_ibm|869">Ελληνικά IBM</option>								<option VALUE="he|1255">Εβραϊκά</option>								<option VALUE="en_hebrew|1252">Ενεργοποίηση εβραϊκών</option>								<option VALUE="hu|1250">Ουγγρικά</option>								<option VALUE="it|1252">Ιταλικά</option>								<option VALUE="ja|932">Ιαπωνικά</option>								<option VALUE="nec|932">Ιαπωνικά NEC</option>								<option VALUE="ko|949">Κορεατικά</option>								<option VALUE="no|1252">Νορβηγικά</option>								<option VALUE="pl|1250">Πολωνικά</option>								<option VALUE="ptbr|1252">Πορτογαλικά (Βραζιλίας)</option>								<option VALUE="pt|1252">Πορτογαλικά (Επίσημα)</option>								<option VALUE="ru|1251">Ρωσικά</option>								<option VALUE="sk|1250">Σλοβακικά</option>								<option VALUE="sl|1250">Σλοβενικά</option>								<option VALUE="es|1252">Ισπανικά</option>								<option VALUE="sv|1252">Σουηδικά</option>								<option VALUE="en_thai|1252">Ενεργοποίηση ταϊλανδικών</option>								<option VALUE="tr|1254">Τουρκικά</option>							</select>-->
						</td>
					</tr>
					<tr><td class="8pt sys-font-body sys-color-body" height="10em"></td></tr>
					<tr><td valign="top"> <a onclick="showadv();return false;" class="10pt sys-font-heading4 sys-link-normal" href="/" onmouseOver="overchangeimage();" onmouseOut="outchangeimage();">Επιλογές σύνθετης αναζήτησης <span id="exco" name="exco"><img id="expando" name="expando" src="/catalog/images/expando_primary_down_normal.gif"></span></a>
					<tr><td class="8pt sys-font-body sys-color-body" height="10em"></td></tr>
					<tr><td>
						<span id="advopt" name="advopt" class="advspan sys-table-color-border sys-rhp-bgcolor sys-table-cell-bgcolor1" style="display:none">
							<table CELLPADDING="0" CELLSPACING="0" BORDER="0" style="padding-left:5px;padding-right:5px">
								<tr><td class="8pt sys-font-body sys-color-body">Ημερομηνία δημοσίευσης στο Web:</td></tr>
								<tr><td height="2"><img src="/catalog/images/ts.gif" HEIGHT="2" WIDTH="1"></td></tr>
								<tr>
									<td class="8pt sys-font-body sys-color-body">
										<select NAME="selPostedDate" ID="selPostedDate">
											<option value="0">Όλες οι ημερομηνίες δημοσίευσης</option>
											<option value="7">Προηγούμενη εβδομάδα</option>
											<option value="14">2 προηγούμενες εβδομάδες</option>
											<option value="30">Προηγούμενος μήνας</option>
											<option value="60">2 προηγούμενοι μήνες</option>
											<option value="180">6 προηγούμενοι μήνες</option>
											<option value="365">Προηγούμενος χρόνος</option>
										</select>
									</td>
								</tr>
								<tr><td height="10em"></td></tr>
								<tr><td class="8pt sys-font-body sys-color-body"><nobr>Περιέχει αυτές τις λέξεις:&nbsp;&nbsp;
																<a class="sys-link-normal" href="javascript:goLearnKeywords()">Πληροφορίες σχετικά με τη χρήση λέξεων για περιορισμό της αναζήτησης</a></nobr></td></tr>
								<tr><td height="2"><img src="/catalog/images/ts.gif" HEIGHT="2" WIDTH="1"></td></tr>
								<tr>
									<td class="8pt sys-font-body sys-color-body">
								...
								<tr><td height="10em"></td></tr>
								<tr><td class="8pt sys-font-body sys-color-body">Τύποι ενημερωμένων εκδόσεων:</td></tr>
								<tr><td class="8pt sys-font-body sys-color-body">
										<table width="100%">
											<tr>
											
														</tr><tr>
													<td class=8pt sys-font-body sys-color-body valign=top><table><tr><td width="20" valign=top><INPUT type=checkbox id=check0 name=check0 value='Critical Updates' checked></td><td class=8pt sys-font-body sys-color-body ><label for=check0>&#922;&#961;&#943;&#963;&#953;&#956;&#949;&#962; &#949;&#957;&#951;&#956;&#949;&#961;&#974;&#963;&#949;&#953;&#962;</label></td></tr></table></td><td class=8pt sys-font-body sys-color-body valign=top><table><tr><td width="20" valign=top><INPUT type=checkbox id=check1 name=check1 value='Advanced Security Updates' checked></td><td class=8pt sys-font-body sys-color-body ><label for=check1>&#928;&#961;&#959;&#951;&#947;&#956;&#941;&#957;&#949;&#962; &#949;&#957;&#951;&#956;&#949;&#961;&#969;&#956;&#941;&#957;&#949;&#962; &#949;&#954;&#948;&#972;&#963;&#949;&#953;&#962; &#945;&#963;&#966;&#945;&#955;&#949;&#943;&#945;&#962;</label></td></tr></table></td>
														</tr><tr>
													<td class=8pt sys-font-body sys-color-body valign=top><table><tr><td width="20" valign=top><INPUT type=checkbox id=check2 name=check2 value='Internet and Multimedia Updates' checked></td><td class=8pt sys-font-body sys-color-body ><label for=check2>&#917;&#957;&#951;&#956;&#949;&#961;&#969;&#956;&#941;&#957;&#949;&#962; &#949;&#954;&#948;&#972;&#963;&#949;&#953;&#962; &#947;&#953;&#945; Internet &#954;&#945;&#953; &#960;&#959;&#955;&#965;&#956;&#941;&#963;&#945;</label></td></tr></table></td><td class=8pt sys-font-body sys-color-body valign=top><table><tr><td width="20" valign=top><INPUT type=checkbox id=check3 name=check3 value='Multi-Language Features' checked></td><td class=8pt sys-font-body sys-color-body ><label for=check3>&#928;&#959;&#955;&#973;&#947;&#955;&#969;&#963;&#963;&#945; &#967;&#945;&#961;&#945;&#954;&#964;&#951;&#961;&#953;&#963;&#964;&#953;&#954;&#940;</label></td></tr></table></td>
														</tr><tr>
													<td class=8pt sys-font-body sys-color-body valign=top><table><tr><td width="20" valign=top><INPUT type=checkbox id=check4 name=check4 value='Recommended Updates' checked></td><td class=8pt sys-font-body sys-color-body ><label for=check4>&#931;&#965;&#957;&#953;&#963;&#964;&#974;&#956;&#949;&#957;&#949;&#962; &#949;&#957;&#951;&#956;&#949;&#961;&#974;&#963;&#949;&#953;&#962;</label></td></tr></table></td>
											</tr>
										</table></td>
								</tr>
							</table>
			...
			<tr><td align="right" class="osbutton sys-table-header-bgcolor1">
				...
				<button onclick="javascript:Docheck();" onresize="document.recalc('true')" style="width:expression(buttonspan.offsetWidth + 10)" id="button1" name="button1"><span id="buttonspan" name="buttonspan">Αναζήτηση</span></button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
			</tr>
		</table>
		<input type="hidden" name="lan" id="lan" value="el">
