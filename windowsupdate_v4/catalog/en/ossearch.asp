...
function Docheck(){
	...
	if (selected == 0){
		alert("Please select at least one update type.");
		return false;
	}
	else{
...
<table cellpadding="0" cellspacing="0" border="0">
	...
	<tr><td class="8pt sys-font-body sys-color-body">Find updates for Windows operating systems. Select from the criteria below, and then click <b>Search</b>.</td></tr>
...
<option value='ver_platform_win32_nt.5.2.amd64.ver_nt_workstation..3790..'><pre>Windows XP x64 Edition Family</pre></option>
					...
					<tr>
						...
						<!--	<select NAME="selLanguage" ID="selLanguage">								<option VALUE="ar|1256">Arabic</option>								<option VALUE="en_arabic|1252">Arabic enabled</option>								<option VALUE="zhcn|936">Chinese Simplified </option>								<option VALUE="zhtw|950">Chinese Traditional </option>								<option VALUE="cs|1250">Czech</option>								<option VALUE="da|1252">Danish</option>								<option VALUE="nl|1252">Dutch</option>								<option VALUE="en|1252" selected>English</option>								<option VALUE="fi|1252">Finnish</option>								<option VALUE="fr|1252">French</option>								<option VALUE="de|1252">German</option>								<option VALUE="el|1253">Greek</option>								<option VALUE="el_ibm|869">Greek IBM</option>								<option VALUE="he|1255">Hebrew</option>								<option VALUE="en_hebrew|1252">Hebrew enabled</option>								<option VALUE="hu|1250">Hungarian</option>								<option VALUE="it|1252">Italian</option>								<option VALUE="ja|932">Japanese</option>								<option VALUE="nec|932">Japanese NEC</option>								<option VALUE="ko|949">Korean</option>								<option VALUE="no|1252">Norwegian</option>								<option VALUE="pl|1250">Polish</option>								<option VALUE="ptbr|1252">Portuguese (Brazilian)</option>								<option VALUE="pt|1252">Portuguese (Standard)</option>								<option VALUE="ru|1251">Russian</option>								<option VALUE="sk|1250">Slovak</option>								<option VALUE="sl|1250">Slovenian</option>								<option VALUE="es|1252">Spanish</option>								<option VALUE="sv|1252">Swedish</option>								<option VALUE="en_thai|1252">Thai enabled</option>								<option VALUE="tr|1254">Turkish</option>							</select>-->
						</td>
					</tr>
					<tr><td class="8pt sys-font-body sys-color-body" height="10em"></td></tr>
					<tr><td valign="top"> <a onclick="showadv();return false;" class="10pt sys-font-heading4 sys-link-normal" href="/" onmouseOver="overchangeimage();" onmouseOut="outchangeimage();">Advanced search options <span id="exco" name="exco"><img id="expando" name="expando" src="/catalog/images/expando_primary_down_normal.gif"></span></a>
					<tr><td class="8pt sys-font-body sys-color-body" height="10em"></td></tr>
					<tr><td>
						<span id="advopt" name="advopt" class="advspan sys-table-color-border sys-rhp-bgcolor sys-table-cell-bgcolor1" style="display:none">
							<table CELLPADDING="0" CELLSPACING="0" BORDER="0" style="padding-left:5px;padding-right:5px">
								...
								<tr><td class="8pt sys-font-body sys-color-body"><nobr>Contains these words:&nbsp;&nbsp;
																<a class="sys-link-normal" href="javascript:goLearnKeywords()">Tell me about using words to limit my search</a></nobr></td></tr>
								<tr><td height="2"><img src="/catalog/images/ts.gif" HEIGHT="2" WIDTH="1"></td></tr>
								<tr>
									<td class="8pt sys-font-body sys-color-body">
								...
								<tr><td height="10em"></td></tr>
								<tr><td class="8pt sys-font-body sys-color-body">Update types:</td></tr>
								<tr><td class="8pt sys-font-body sys-color-body">
										<table width="100%">
											<tr>
											
														</tr><tr>
													<td class=8pt sys-font-body sys-color-body valign=top><table><tr><td width="20" valign=top><INPUT type=checkbox id=check0 name=check0 value='Critical Updates' checked></td><td class=8pt sys-font-body sys-color-body ><label for=check0>Critical Updates and Service Packs</label></td></tr></table></td><td class=8pt sys-font-body sys-color-body valign=top><table><tr><td width="20" valign=top><INPUT type=checkbox id=check1 name=check1 value='Advanced Security Updates' checked></td><td class=8pt sys-font-body sys-color-body ><label for=check1>Advanced Security Updates</label></td></tr></table></td>
														</tr><tr>
													<td class=8pt sys-font-body sys-color-body valign=top><table><tr><td width="20" valign=top><INPUT type=checkbox id=check2 name=check2 value='Additional Windows Downloads' checked></td><td class=8pt sys-font-body sys-color-body ><label for=check2>Additional Windows Downloads</label></td></tr></table></td><td class=8pt sys-font-body sys-color-body valign=top><table><tr><td width="20" valign=top><INPUT type=checkbox id=check3 name=check3 value='Internet and Multimedia Updates' checked></td><td class=8pt sys-font-body sys-color-body ><label for=check3>Internet and Multimedia Updates</label></td></tr></table></td>
														</tr><tr>
													<td class=8pt sys-font-body sys-color-body valign=top><table><tr><td width="20" valign=top><INPUT type=checkbox id=check4 name=check4 value='Multi-Language Features' checked></td><td class=8pt sys-font-body sys-color-body ><label for=check4>Multi-Language Features</label></td></tr></table></td><td class=8pt sys-font-body sys-color-body valign=top><table><tr><td width="20" valign=top><INPUT type=checkbox id=check5 name=check5 value='Recommended Updates' checked></td><td class=8pt sys-font-body sys-color-body ><label for=check5>Recommended Updates</label></td></tr></table></td>
														</tr><tr>
													<td class=8pt sys-font-body sys-color-body valign=top><table><tr><td width="20" valign=top><INPUT type=checkbox id=check6 name=check6 value='Windows Tools' checked></td><td class=8pt sys-font-body sys-color-body ><label for=check6>Windows Tools</label></td></tr></table></td>
											</tr>
										</table></td>
								</tr>
							</table>
			...
			<tr><td align="right" class="osbutton sys-table-header-bgcolor1">
				...
				<button onclick="javascript:Docheck();" onresize="document.recalc('true')" style="width:expression(buttonspan.offsetWidth + 10)" id="button1" name="button1"><span id="buttonspan" name="buttonspan">Search</span></button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
			</tr>
		</table>
		<input type="hidden" name="lan" id="lan" value="en">
		<input type="hidden" value="6" id="num" name="num">
