...
<table cellpadding="0" cellspacing="0" border="0">
	...
	<tr><td class="8pt sys-font-body sys-color-body" valign="top">
			<b>החיפוש שלך מצא  <span id="totalitems"></span>&nbsp; תוצאות</b> <br/>בחר מתוך הרשימה למטה כדי לראות את העדכונים שנמצאו בכל קטגוריה.</td>
	</tr>
	...
	<tr><td id="info" class="8pt sys-font-body sys-color-body" align="center" valign="bottom">
		<img src="/catalog/images/ts.gif" width="1" height="100"><b>נא לבחור קטגוריה מהרשימה למעלה.</b></td>
	</tr>
	...
	<tr><td id="gotobasket" class="8pt sys-font-body sys-color-body" align="left" valign="top" style="visibility:hidden">
		<table cellpadding="0" cellspacing="0" border="0" width="100%">
			...
			<tr>
				<td colspan="2" class="8pt sys-font-body sys-color-body" valign="top" align='left'>מיין לפי: 
					<select onchange="sortitems()" name="sortselect" id="sortselect">
						<option value="0">כותרת</option>
						<option value="2">תאריך הצגה</option>
					</select>
				</td>
