...
function Docheck(){
	...
	if (selected == 0){
		alert("נא לבחור לפחות סוג עדכון אחד.");
		return false;
	}
	else{
...
<table cellpadding="0" cellspacing="0" border="0">
	...
	<tr><td class="8pt sys-font-body sys-color-body">מצא עדכונים עבור מערכות ההפעלה של Windows. בחר מתוך הקריטריונים למטה ולחץ על <b>חפש</b>.</td></tr>
		...
		<table cellpadding="0" cellspacing="0" leftmargin="0" height="100%" class="tblborder sys-table-color-border sys-table-cell-bgcolor2" border="0">
			<tr><td>
				<table cellpadding="0" cellspacing="0" border="0" class="innertbl" height="100%"  style="padding-right:10px" >
					...
					<tr><td class="8pt sys-font-body sys-color-body">מערכת הפעלה:</td></tr>
...
<option value='ver_platform_win32_nt.5.2.amd64.ver_nt_workstation..3790..'><pre>Windows XP x64 Edition Family</pre></option>
					...
					<tr><td class="8pt sys-font-body sys-color-body">שפה: </td></tr>
					...
					<tr>
						...
						<!--	<select NAME="selLanguage" ID="selLanguage">								<option VALUE="ar|1256">ערבית</option>								<option VALUE="en_arabic|1252">תומך בערבית</option>								<option VALUE="zhcn|936">סינית פשוטה </option>								<option VALUE="zhtw|950">סינית טאיוונית (מסורתית)</option>								<option VALUE="cs|1250">צ'כית</option>								<option VALUE="da|1252">דנית</option>								<option VALUE="nl|1252">הולנדית</option>								<option VALUE="en|1252" selected>אנגלית</option>								<option VALUE="fi|1252">פינית</option>								<option VALUE="fr|1252">צרפתית</option>								<option VALUE="de|1252">גרמנית</option>								<option VALUE="el|1253">יוונית</option>								<option VALUE="el_ibm|869">יוונית IBM</option>								<option VALUE="he|1255">עברית</option>								<option VALUE="en_hebrew|1252">תומך עברית</option>								<option VALUE="hu|1250">הונגרית</option>								<option VALUE="it|1252">איטלקית</option>								<option VALUE="ja|932">יפנית</option>								<option VALUE="nec|932">יפנית NEC</option>								<option VALUE="ko|949">קוריאנית</option>								<option VALUE="no|1252">נורווגית</option>								<option VALUE="pl|1250">פולנית</option>								<option VALUE="ptbr|1252">פורטוגזית (ברזילאית)</option>								<option VALUE="pt|1252">פורטוגזית (תקנית)</option>								<option VALUE="ru|1251">רוסית</option>								<option VALUE="sk|1250">סלובקית</option>								<option VALUE="sl|1250">סלובנית</option>								<option VALUE="es|1252">ספרדית</option>								<option VALUE="sv|1252">שוודית</option>								<option VALUE="en_thai|1252">תומך תאיית</option>								<option VALUE="tr|1254">טורקית</option>							</select>-->
						</td>
					</tr>
					<tr><td class="8pt sys-font-body sys-color-body" height="10em"></td></tr>
					<tr><td valign="top"> <a onclick="showadv();return false;" class="10pt sys-font-heading4 sys-link-normal" href="/" onmouseOver="overchangeimage();" onmouseOut="outchangeimage();">אפשרויות חיפוש מתקדמות <span id="exco" name="exco"><img id="expando" name="expando" src="/catalog/images/expando_primary_down_normal.gif"></span></a>
					<tr><td class="8pt sys-font-body sys-color-body" height="10em"></td></tr>
					<tr><td>
						<span id="advopt" name="advopt" class="advspan sys-table-color-border sys-rhp-bgcolor sys-table-cell-bgcolor1" style="display:none">
							<table CELLPADDING="0" CELLSPACING="0" BORDER="0" style="padding-left:5px;padding-right:5px">
								<tr><td class="8pt sys-font-body sys-color-body">תאריך פרסום באינטרנט:</td></tr>
								<tr><td height="2"><img src="/catalog/images/ts.gif" HEIGHT="2" WIDTH="1"></td></tr>
								<tr>
									<td class="8pt sys-font-body sys-color-body">
										<select NAME="selPostedDate" ID="selPostedDate">
											<option value="0">כל התאריכים המוצגים</option>
											...
											<option value="180">בששת החודשים האחרונים</option>
											<option value="365">בשנה האחרונה</option>
										</select>
									</td>
								</tr>
								<tr><td height="10em"></td></tr>
								<tr><td class="8pt sys-font-body sys-color-body"><nobr>מכיל מילים אלה:&nbsp;&nbsp;
																<a class="sys-link-normal" href="javascript:goLearnKeywords()">ספר לי כיצד מילים יכולות למקד את החיפוש שלי</a></nobr></td></tr>
								<tr><td height="2"><img src="/catalog/images/ts.gif" HEIGHT="2" WIDTH="1"></td></tr>
								<tr>
									<td class="8pt sys-font-body sys-color-body">
								...
								<tr><td height="10em"></td></tr>
								<tr><td class="8pt sys-font-body sys-color-body">סוגי עדכונים:</td></tr>
								<tr><td class="8pt sys-font-body sys-color-body">
										<table width="100%">
											<tr>
											
														</tr><tr>
													<td class=8pt sys-font-body sys-color-body valign=top><table><tr><td width="20" valign=top><INPUT type=checkbox id=check0 name=check0 value='Critical Updates' checked></td><td class=8pt sys-font-body sys-color-body ><label for=check0>&#1506;&#1491;&#1499;&#1493;&#1504;&#1497;&#1501; &#1511;&#1512;&#1497;&#1496;&#1497;&#1497;&#1501; &#1493;&#1495;&#1489;&#1497;&#1500;&#1493;&#1514; &#1506;&#1491;&#1499;&#1493;&#1503; (Service Packs)</label></td></tr></table></td><td class=8pt sys-font-body sys-color-body valign=top><table><tr><td width="20" valign=top><INPUT type=checkbox id=check1 name=check1 value='Advanced Security Updates' checked></td><td class=8pt sys-font-body sys-color-body ><label for=check1>&#1506;&#1491;&#1499;&#1493;&#1503; &#1500;&#1513;&#1497;&#1512;&#1493;&#1514;&#1497; &#1492;&#1514;&#1511;&#1504;&#1492; &#1502;&#1512;&#1495;&#1493;&#1511;</label></td></tr></table></td>
														</tr><tr>
													<td class=8pt sys-font-body sys-color-body valign=top><table><tr><td width="20" valign=top><INPUT type=checkbox id=check2 name=check2 value='Internet and Multimedia Updates' checked></td><td class=8pt sys-font-body sys-color-body ><label for=check2>&#1506;&#1491;&#1499;&#1493;&#1504;&#1497; &#1488;&#1497;&#1504;&#1496;&#1512;&#1504;&#1496; &#1493;&#1502;&#1493;&#1500;&#1496;&#1497;&#1502;&#1491;&#1497;&#1492;</label></td></tr></table></td><td class=8pt sys-font-body sys-color-body valign=top><table><tr><td width="20" valign=top><INPUT type=checkbox id=check3 name=check3 value='Multi-Language Features' checked></td><td class=8pt sys-font-body sys-color-body ><label for=check3>&#1514;&#1499;&#1493;&#1504;&#1493;&#1514; &#1513;&#1500; &#1512;&#1497;&#1489;&#1493;&#1497; &#1513;&#1508;&#1493;&#1514;</label></td></tr></table></td>
														</tr><tr>
													<td class=8pt sys-font-body sys-color-body valign=top><table><tr><td width="20" valign=top><INPUT type=checkbox id=check4 name=check4 value='Recommended Updates' checked></td><td class=8pt sys-font-body sys-color-body ><label for=check4>&#1506;&#1491;&#1499;&#1493;&#1504;&#1497;&#1501; &#1502;&#1493;&#1502;&#1500;&#1510;&#1497;&#1501;</label></td></tr></table></td>
											</tr>
										</table></td>
								</tr>
							</table>
			...
			<tr><td align="left" class="osbutton sys-table-header-bgcolor1">
				...
				<button onclick="javascript:Docheck();" onresize="document.recalc('true')" style="width:expression(buttonspan.offsetWidth + 10)" id="button1" name="button1"><span id="buttonspan" name="buttonspan">חפש</span></button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
			</tr>
		</table>
		<input type="hidden" name="lan" id="lan" value="he">
