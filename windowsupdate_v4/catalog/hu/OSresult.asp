...
<table cellpadding="0" cellspacing="0" border="0">
	...
	<tr><td class="8pt sys-font-body sys-color-body" valign="top">
			<b>A keresés <span id="totalitems"></span>&nbsp; eredményt adott vissza.</b> <br/>Válasszon az alábbi listából az egyes kategóriákban talált frissítések megtekintéséhez.</td>
	</tr>
	...
	<tr><td id="info" class="8pt sys-font-body sys-color-body" align="center" valign="bottom">
		<img src="/catalog/images/ts.gif" width="1" height="100"><b>Válasszon egy kategóriát a fenti listából.</b></td>
	</tr>
	...
	<tr><td id="gotobasket" class="8pt sys-font-body sys-color-body" align="left" valign="top" style="visibility:hidden">
		<table cellpadding="0" cellspacing="0" border="0" width="100%">
			...
			<tr>
				<td class="8pt sys-font-body sys-color-body" valign="top" width="50%"><a class="sys-link-normal" href="/" onclick="javascript:gobasket();return false;"><img alt="Egy feladatra vagy mûveletre mutató, zöld nyílat ábrázoló ikon." src="/catalog/images/green_arrow.gif" border="0"  style="padding-bottom:-5px;" align=absmiddle WIDTH="30" HEIGHT="25">A frissítési kosár megjelenítése</a></td>
				<td class="8pt sys-font-body sys-color-body" align="right">A letöltési kosárban lévõ elemek száma:<span id="eViewBasket"> </span> <span id="eBasketStats"></span> </td>
			</tr>
			<tr>
				<td colspan="2" HEIGHT="6"><img src="/catalog/images/ts.gif" HEIGHT="10"></td>
			</tr>
			<tr>
				<td colspan="2" class="8pt sys-font-body sys-color-body" valign="top" align='right'>Rendezés a következõ szerint: 
					<select onchange="sortitems()" name="sortselect" id="sortselect">
						<option value="0">Cím</option>
						<option value="2">Megjelenés dátuma</option>
					</select>
				</td>
