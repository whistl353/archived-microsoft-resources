	...
	<script language="JScript">
		...
		aRows = eSortTable.rows
			...
			for (i=0;i<buttonarray.length;i++){
				if(buttonarray[i].innerHTML == "Hozzáadás")
					buttonarray[i].style.width = addlength
				if(buttonarray[i].innerHTML == "Eltávolítás")
...
<table cellspacing="0" cellpadding="0" border="0">
	<tbody>
	<tr><td height="1"><span class="8pt sys-font-body sys-color-body" id="addspan" name="addspan" style="visibility:hidden;height=1;overflow;hidden">Hozzáadás</span><span class="8pt sys-font-body sys-color-body" name="removespan" id="removespan" style="visibility:hidden;height=1;overflow;hidden">Eltávolítás</span></td></tr>
		<tr>
			<td valign="top" height="40em">
				<div>
					<div valign="middle" style="background-color:#Ffffcc;padding-top:3;padding-bottom:5;padding-left:10">
						...
						<span class="title sys-font-heading3 sys-rhp-color-title">Letöltési kosár</span></nobr>
					</div>
				</div></td>
		</tr>
		<tr>
			<td valign="top">
				<div name="reviewandinstall"id="reviewandinstall">
					<div   class="8pt sys-font-body sys-color-body"><b>A kijelölt frissítések áttekintése és letöltése</b></div>
					<div  class="8pt sys-font-body sys-color-body"><!--<img src="/catalog/images/ts.gif" height="1" width="56">-->Adja meg a letöltés helyét, majd kattintson a <b>Letöltés</b> gombra. Ha ki szeretne venni egy elemet a kosárból, kattintson az <b>Eltávolítás</b> gombra.</div>
				</div>
				<div name="noreviewandinstall"id="noreviewandinstall" style="display:none">
					<div   class="8pt sys-font-body sys-color-body"><b><b>A kosár üres.</b></b></div>
					<div  class="8pt sys-font-body sys-color-body"><!--<img src="/catalog/images/ts.gif" height="1" width="56">-->A letölteni kívánt frissítések kiválasztásához kattintson a <b>Köszöntjük a Windows Update katalógusban!</b> elemre vagy az alatta lévõ egyik kategóriára, majd adja meg a keresési feltételeket.</div>
				</div>
			</td>
		</tr>
		<tr>
			...
			<form name="txtform" id="textform" action="downloadbasket.asp" onsubmit="return downloadnow();">
				<div>
					<div class="8pt sys-font-body sys-color-body">&nbsp;<br><nobr>Írja be vagy tallózással adja meg a letöltés helyét:</nobr></div>
					<div class="10pt sys-font-heading4">
						...
						<button onresize="document.recalc('true')" style="width:expression(browsespan.offsetWidth + 10)" onClick="javascript:goBrowse()" id="browseb" name="browseb">
							<span id="browsespan" name="browsespan">Tallózás...</span></button></nobr>
					...
					<table cellpadding="0" cellspacing="0" border="0">
						<tr>
							<td class="8pt sys-font-body sys-color-body">
								...
								<button id="dnow" name="dnow" type="submit" style="width:expression(downspan.offsetWidth + 10)" disabled><span name="downspan" id="downspan">Letöltés</span></button>
								<br>
							</td>
						</tr>
					</table>
		...
		<tr>
			<td class="resultsBasketBar sys-table-header-bgcolor1 sys-table-color-border sys-toppane-header-color" valign="top">
				<span id="eBasketCalculating">Összesen (az elõfeltételekkel együtt):</span> <span id="eBasketStats"></span>
			</td>
		</tr>
		<tr>
			<td height="100%">
...
//fnSortTable(2,false)
	...
	var Minute="perc";
	var Minutes="perc";
	var DownloadSize="Letöltési méret:"
	var MB="MB"
	var KB="KB"
	var basketarray=parent.frames["eTOC"].sBasketString.split(",");
...
//alert(controlxml)
		...
		if(bstrStartFolder == "" || false == bstrStartFolder) {
			var badpath="A Windows Update nem tud elemeket letöltemo a megadott mappába. A mappa nem létezik, vagy Ön nem rendelkezik engedéllyel ahhoz, hogy elemeket adjon hozzá. Ellenõrizze, hogy helyes-e a megadott elérési út, vagy adjon meg másik helyet.";
			alert(badpath);
			return false;
		}
	...
	function goBrowse() {
		...
		if(pbstrFolder.length >=50){
			...
			sAlert = 'A letöltési út legfeljebb 49 karaktert tartalmazhat. A megadott útvonal:\n\r' + pbstrFolder + "\n\r\n\r" + 'Írjon be vagy tallózással válasszon ki egy letöltési utat, amely 50 karakternél rövidebb.'
			alert(sAlert)
		}
