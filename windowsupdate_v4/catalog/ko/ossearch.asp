...
<table cellpadding="0" cellspacing="0" border="0">
	...
	<tr><td class="8pt sys-font-body sys-color-body">Windows 운영 체제를 위한 업데이트를 검색하십시오. 아래의 조건에서 선택한 후 <b>검색</b>을 클릭하십시오.</td></tr>
...
<option value='ver_platform_win32_nt.5.2.amd64.ver_nt_workstation..3790..'><pre>Windows XP x64 Edition Family</pre></option>
					...
					<tr>
						...
						<!--	<select NAME="selLanguage" ID="selLanguage">								<option VALUE="ar|1256">아랍어</option>								<option VALUE="en_arabic|1252">아랍어 사용</option>								<option VALUE="zhcn|936">중국어 간체</option>								<option VALUE="zhtw|950">중국어 번체</option>								<option VALUE="cs|1250">체코어</option>								<option VALUE="da|1252">덴마크어</option>								<option VALUE="nl|1252">네덜란드어</option>								<option VALUE="en|1252" selected>영어</option>								<option VALUE="fi|1252">핀란드어</option>								<option VALUE="fr|1252">프랑스어</option>								<option VALUE="de|1252">독일어</option>								<option VALUE="el|1253">그리스어</option>								<option VALUE="el_ibm|869">그리스어 IBM</option>								<option VALUE="he|1255">히브리어</option>								<option VALUE="en_hebrew|1252">히브리어 사용</option>								<option VALUE="hu|1250">헝가리어</option>								<option VALUE="it|1252">이탈리아어</option>								<option VALUE="ja|932">일본어</option>								<option VALUE="nec|932">일본어 NEC</option>								<option VALUE="ko|949">한국어</option>								<option VALUE="no|1252">노르웨이어</option>								<option VALUE="pl|1250">폴란드어</option>								<option VALUE="ptbr|1252">포르투갈어(브라질)</option>								<option VALUE="pt|1252">포르투갈어(포르투갈)</option>								<option VALUE="ru|1251">러시아어</option>								<option VALUE="sk|1250">슬로바키아어</option>								<option VALUE="sl|1250">슬로베니아어</option>								<option VALUE="es|1252">스페인어</option>								<option VALUE="sv|1252">스웨덴어</option>								<option VALUE="en_thai|1252">타이어 사용</option>								<option VALUE="tr|1254">터키어</option>							</select>-->
						</td>
					</tr>
					<tr><td class="8pt sys-font-body sys-color-body" height="10em"></td></tr>
					<tr><td valign="top"> <a onclick="showadv();return false;" class="10pt sys-font-heading4 sys-link-normal" href="/" onmouseOver="overchangeimage();" onmouseOut="outchangeimage();">고급 검색 옵션 <span id="exco" name="exco"><img id="expando" name="expando" src="/catalog/images/expando_primary_down_normal.gif"></span></a>
					<tr><td class="8pt sys-font-body sys-color-body" height="10em"></td></tr>
					<tr><td>
						<span id="advopt" name="advopt" class="advspan sys-table-color-border sys-rhp-bgcolor sys-table-cell-bgcolor1" style="display:none">
							<table CELLPADDING="0" CELLSPACING="0" BORDER="0" style="padding-left:5px;padding-right:5px">
								...
								<tr><td class="8pt sys-font-body sys-color-body"><nobr>포함된 단어:&nbsp;&nbsp;
																<a class="sys-link-normal" href="javascript:goLearnKeywords()">검색의 범위를 좁히기 위한 단어 사용 방법</a></nobr></td></tr>
								<tr><td height="2"><img src="/catalog/images/ts.gif" HEIGHT="2" WIDTH="1"></td></tr>
								<tr>
									<td class="8pt sys-font-body sys-color-body">
								...
								<tr><td height="10em"></td></tr>
								<tr><td class="8pt sys-font-body sys-color-body">업데이트 형식:</td></tr>
								<tr><td class="8pt sys-font-body sys-color-body">
										<table width="100%">
											<tr>
											
														</tr><tr>
													<td class=8pt sys-font-body sys-color-body valign=top><table><tr><td width="20" valign=top><INPUT type=checkbox id=check0 name=check0 value='Critical Updates' checked></td><td class=8pt sys-font-body sys-color-body ><label for=check0>중요 업데이트 및 서비스 팩</label></td></tr></table></td><td class=8pt sys-font-body sys-color-body valign=top><table><tr><td width="20" valign=top><INPUT type=checkbox id=check1 name=check1 value='Advanced Security Updates' checked></td><td class=8pt sys-font-body sys-color-body ><label for=check1>고급 보안 업데이트</label></td></tr></table></td>
														</tr><tr>
													<td class=8pt sys-font-body sys-color-body valign=top><table><tr><td width="20" valign=top><INPUT type=checkbox id=check2 name=check2 value='Additional Windows Downloads' checked></td><td class=8pt sys-font-body sys-color-body ><label for=check2>추가 Windows 다운로드</label></td></tr></table></td><td class=8pt sys-font-body sys-color-body valign=top><table><tr><td width="20" valign=top><INPUT type=checkbox id=check3 name=check3 value='Internet and Multimedia Updates' checked></td><td class=8pt sys-font-body sys-color-body ><label for=check3>인터넷 및 멀티미디어 업데이트</label></td></tr></table></td>
														</tr><tr>
													<td class=8pt sys-font-body sys-color-body valign=top><table><tr><td width="20" valign=top><INPUT type=checkbox id=check4 name=check4 value='Multi-Language Features' checked></td><td class=8pt sys-font-body sys-color-body ><label for=check4>다중 언어 기능</label></td></tr></table></td><td class=8pt sys-font-body sys-color-body valign=top><table><tr><td width="20" valign=top><INPUT type=checkbox id=check5 name=check5 value='Recommended Updates' checked></td><td class=8pt sys-font-body sys-color-body ><label for=check5>권장 업데이트</label></td></tr></table></td>
											</tr>
										</table></td>
								</tr>
							</table>
			...
			<tr><td align="right" class="osbutton sys-table-header-bgcolor1">
				...
				<button onclick="javascript:Docheck();" onresize="document.recalc('true')" style="width:expression(buttonspan.offsetWidth + 10)" id="button1" name="button1"><span id="buttonspan" name="buttonspan">검색</span></button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
			</tr>
		</table>
		<input type="hidden" name="lan" id="lan" value="ko">
