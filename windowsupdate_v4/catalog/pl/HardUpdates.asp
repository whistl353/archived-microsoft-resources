...
<form name="frmMan" id="frmMan" action="driverDetails.asp" onsubmit="return frmsubmitcheck()">
	...
	<table cellspacing="0" cellpadding="0" border="0" height="90%">
		<tbody>
			<tr>
				<td valign="top">
					<span class="title sys-font-heading3 sys-rhp-color-title">Wyniki wyszukiwania:</span></td>
			</tr>
			<tr>
				<td  class="8pt sys-font-body sys-color-body">Liczba znalezionych wyników:  <b><span id="results" name="results">0</span></b> &nbsp; wyniki &nbsp;&nbsp;&nbsp;</td>
			</tr>
			<tr><td valign="top">
			...
			<tr>
				<td height="100%" valign="top">
					<center>
						...
						<span class="10pt sys-font-heading4"><b>Liczba znalezionych wyników: 0.</b></span>
					</center>
				</td>
			</tr>
		</tbody>
