	...
	<script language="JScript">
		...
		aRows = eSortTable.rows
			...
			for (i=0;i<buttonarray.length;i++){
				if(buttonarray[i].innerHTML == "Dodaj")
					buttonarray[i].style.width = addlength
				if(buttonarray[i].innerHTML == "Usuñ")
...
<table cellspacing="0" cellpadding="0" border="0">
	<tbody>
	<tr><td height="1"><span class="8pt sys-font-body sys-color-body" id="addspan" name="addspan" style="visibility:hidden;height=1;overflow;hidden">Dodaj</span><span class="8pt sys-font-body sys-color-body" name="removespan" id="removespan" style="visibility:hidden;height=1;overflow;hidden">Usuñ</span></td></tr>
		<tr>
			<td valign="top" height="40em">
				<div>
					<div valign="middle" style="background-color:#Ffffcc;padding-top:3;padding-bottom:5;padding-left:10">
						...
						<span class="title sys-font-heading3 sys-rhp-color-title">Koszyk pobierania</span></nobr>
					</div>
				</div></td>
		</tr>
		<tr>
			<td valign="top">
				<div name="reviewandinstall"id="reviewandinstall">
					<div   class="8pt sys-font-body sys-color-body"><b>Przejrzyj i zainstaluj wybrane aktualizacje</b></div>
					<div  class="8pt sys-font-body sys-color-body"><!--<img src="/catalog/images/ts.gif" height="1" width="56">-->Zaznacz wybran¹ lokalizacjê pobierania, a nastêpnie kliknij przycisk <b>Pobierz teraz</b>. Aby usun¹æ element z koszyka, kliknij przycisk <b>Usuñ</b>.</div>
				</div>
				<div name="noreviewandinstall"id="noreviewandinstall" style="display:none">
					<div   class="8pt sys-font-body sys-color-body"><b><b>W koszyku nie ma aktualizacji</b></b></div>
					<div  class="8pt sys-font-body sys-color-body"><!--<img src="/catalog/images/ts.gif" height="1" width="56">-->Aby wybraæ aktualizacje do pobrania, kliknij ³¹cze <b>Katalog rozszerzenia Windows Update - Zapraszamy!</b> lub kategoriê znajduj¹c¹ siê poni¿ej i przeœlij kryteria wyszukiwania.</div>
				</div>
			</td>
		</tr>
		<tr>
			...
			<form name="txtform" id="textform" action="downloadbasket.asp" onsubmit="return downloadnow();">
				<div>
					<div class="8pt sys-font-body sys-color-body">&nbsp;<br><nobr>Wpisz lub przejrzyj wybran¹ lokalizacjê pobranego pliku:</nobr></div>
					<div class="10pt sys-font-heading4">
						...
						<button onresize="document.recalc('true')" style="width:expression(browsespan.offsetWidth + 10)" onClick="javascript:goBrowse()" id="browseb" name="browseb">
							<span id="browsespan" name="browsespan">Przegl¹daj...</span></button></nobr>
					...
					<table cellpadding="0" cellspacing="0" border="0">
						<tr>
							<td class="8pt sys-font-body sys-color-body">
								...
								<button id="dnow" name="dnow" type="submit" style="width:expression(downspan.offsetWidth + 10)" disabled><span name="downspan" id="downspan">Pobierz teraz</span></button>
								<br>
							</td>
						</tr>
					</table>
		...
		<tr>
			<td class="resultsBasketBar sys-table-header-bgcolor1 sys-table-color-border sys-toppane-header-color" valign="top">
				<span id="eBasketCalculating">Razem (w tym wymagania wstêpne):</span> <span id="eBasketStats"></span>
			</td>
		</tr>
		<tr>
			<td height="100%">
				<div id="eUpdatesContainer" class="eUpdatesContainer sys-table-color-border sys-table-cell-bgcolor2">
					...
					<div id="noupdates" class="8pt sys-font-body sys-color-body" style="display:none">
						...
						<p>
						<center>
						<b>W koszyku nie ma aktualizacji.</b>
						</center>
					</div>
...
//fnSortTable(2,false)
	...
	var Minute="minuta";
	var Minutes="min";
	var DownloadSize="Rozmiar pobieranego pliku:"
	var MB="MB"
	var KB="KB"
	var basketarray=parent.frames["eTOC"].sBasketString.split(",");
...
//alert(controlxml)
		...
		if(bstrStartFolder == "" || false == bstrStartFolder) {
			var badpath="Rozszerzenie Windows Update nie mo¿e przekazaæ do okreœlonego folderu. Albo folder nie istnieje, albo nie masz uprawnieñ do dodawanie do niego elementów. Upewnij siê, ¿e œcie¿ka do folderu zosta³a okreœlona poprawnie lub okreœl inn¹ lokalizacjê.";
			alert(badpath);
			return false;
		}
	...
	function goBrowse() {
		...
		if(pbstrFolder.length >=50){
			...
			sAlert = 'Œcie¿ka pobierania musi zawieraæ mniej ni¿ 50 znaków. Zdefiniowano nastêpuj¹c¹ œcie¿kê: \n\r' + pbstrFolder + "\n\r\n\r" + 'Wpisz lub przegl¹daj, aby wybraæ œcie¿kê pobierania o d³ugoœci mniejszej ni¿ 50 znaków.'
			alert(sAlert)
		}
