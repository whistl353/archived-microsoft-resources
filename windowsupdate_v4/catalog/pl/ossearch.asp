...
function Docheck(){
	...
	if (selected == 0){
		alert("Wybierz co najmniej jeden typ aktualizacji.");
		return false;
	}
	else{
...
<table cellpadding="0" cellspacing="0" border="0">
	...
	<tr><td class="8pt sys-font-body sys-color-body">ZnajdŸ aktualizacje dla systemów Windows. Wybierz z poni¿szych kryteriów i kliknij przycisk <b>Wyszukaj</b>.</td></tr>
...
<option value='ver_platform_win32_nt.5.2.amd64.ver_nt_workstation..3790..'><pre>Windows XP x64 Edition Family</pre></option>
					...
					<tr><td class="8pt sys-font-body sys-color-body">Jêzyk: </td></tr>
					...
					<tr>
						...
						<!--	<select NAME="selLanguage" ID="selLanguage">								<option VALUE="ar|1256">Arabski</option>								<option VALUE="en_arabic|1252">W³¹czona obs³uga jêzyka arabskiego</option>								<option VALUE="zhcn|936">Chiñski uproszczony </option>								<option VALUE="zhtw|950">Chiñski tradycyjny </option>								<option VALUE="cs|1250">Czeski</option>								<option VALUE="da|1252">Duñski</option>								<option VALUE="nl|1252">Holenderski</option>								<option VALUE="en|1252" selected>Angielski</option>								<option VALUE="fi|1252">Fiñski</option>								<option VALUE="fr|1252">Francuski</option>								<option VALUE="de|1252">Niemiecki</option>								<option VALUE="el|1253">Grecki</option>								<option VALUE="el_ibm|869">Grecki (IBM)</option>								<option VALUE="he|1255">Hebrajski</option>								<option VALUE="en_hebrew|1252">W³¹czona obs³uga jêzyka hebrajskiego</option>								<option VALUE="hu|1250">Wêgierski</option>								<option VALUE="it|1252">W³oski</option>								<option VALUE="ja|932">Japoñski</option>								<option VALUE="nec|932">Japoñski (NEC)</option>								<option VALUE="ko|949">Koreañski</option>								<option VALUE="no|1252">Norweski</option>								<option VALUE="pl|1250">Polski</option>								<option VALUE="ptbr|1252">Portugalski (Brazylia)</option>								<option VALUE="pt|1252">Portugalski (standardowy)</option>								<option VALUE="ru|1251">Rosyjski</option>								<option VALUE="sk|1250">S³owacki</option>								<option VALUE="sl|1250">S³oweñski</option>								<option VALUE="es|1252">Hiszpañski</option>								<option VALUE="sv|1252">Szwedzki</option>								<option VALUE="en_thai|1252">W³¹czona obs³uga jêzyka tajlandzkiego</option>								<option VALUE="tr|1254">Turecki</option>							</select>-->
						</td>
					</tr>
					<tr><td class="8pt sys-font-body sys-color-body" height="10em"></td></tr>
					<tr><td valign="top"> <a onclick="showadv();return false;" class="10pt sys-font-heading4 sys-link-normal" href="/" onmouseOver="overchangeimage();" onmouseOut="outchangeimage();">Zaawansowane opcje wyszukiwania <span id="exco" name="exco"><img id="expando" name="expando" src="/catalog/images/expando_primary_down_normal.gif"></span></a>
					<tr><td class="8pt sys-font-body sys-color-body" height="10em"></td></tr>
					<tr><td>
						<span id="advopt" name="advopt" class="advspan sys-table-color-border sys-rhp-bgcolor sys-table-cell-bgcolor1" style="display:none">
							<table CELLPADDING="0" CELLSPACING="0" BORDER="0" style="padding-left:5px;padding-right:5px">
								...
								<tr><td class="8pt sys-font-body sys-color-body"><nobr>Zawiera nastêpuj¹ce wyrazy:&nbsp;&nbsp;
																<a class="sys-link-normal" href="javascript:goLearnKeywords()">Informacje o stosowaniu s³ów do precyzowania wyszukiwania</a></nobr></td></tr>
								<tr><td height="2"><img src="/catalog/images/ts.gif" HEIGHT="2" WIDTH="1"></td></tr>
								<tr>
									<td class="8pt sys-font-body sys-color-body">
								...
								<tr><td height="10em"></td></tr>
								<tr><td class="8pt sys-font-body sys-color-body">Typy aktualizacji:</td></tr>
								<tr><td class="8pt sys-font-body sys-color-body">
										<table width="100%">
											<tr>
											
														</tr><tr>
													<td class=8pt sys-font-body sys-color-body valign=top><table><tr><td width="20" valign=top><INPUT type=checkbox id=check0 name=check0 value='Critical Updates' checked></td><td class=8pt sys-font-body sys-color-body ><label for=check0>Wa&#380;ne aktualizacje i dodatki Service Pack</label></td></tr></table></td><td class=8pt sys-font-body sys-color-body valign=top><table><tr><td width="20" valign=top><INPUT type=checkbox id=check1 name=check1 value='Advanced Security Updates' checked></td><td class=8pt sys-font-body sys-color-body ><label for=check1>Zaawansowane aktualizacje zabezpiecze&#324;</label></td></tr></table></td>
														</tr><tr>
													<td class=8pt sys-font-body sys-color-body valign=top><table><tr><td width="20" valign=top><INPUT type=checkbox id=check2 name=check2 value='Internet and Multimedia Updates' checked></td><td class=8pt sys-font-body sys-color-body ><label for=check2>Aktualizacje dotycz&#261;ce Internetu i multimedi&#243;w</label></td></tr></table></td><td class=8pt sys-font-body sys-color-body valign=top><table><tr><td width="20" valign=top><INPUT type=checkbox id=check3 name=check3 value='Multi-Language Features' checked></td><td class=8pt sys-font-body sys-color-body ><label for=check3>Funkcje instalacji wieloj&#281;zycznej</label></td></tr></table></td>
														</tr><tr>
													<td class=8pt sys-font-body sys-color-body valign=top><table><tr><td width="20" valign=top><INPUT type=checkbox id=check4 name=check4 value='Recommended Updates' checked></td><td class=8pt sys-font-body sys-color-body ><label for=check4>Zalecane aktualizacje</label></td></tr></table></td>
											</tr>
										</table></td>
								</tr>
							</table>
			...
			<tr><td align="right" class="osbutton sys-table-header-bgcolor1">
				...
				<button onclick="javascript:Docheck();" onresize="document.recalc('true')" style="width:expression(buttonspan.offsetWidth + 10)" id="button1" name="button1"><span id="buttonspan" name="buttonspan">Wyszukaj</span></button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
			</tr>
		</table>
		<input type="hidden" name="lan" id="lan" value="pl">
