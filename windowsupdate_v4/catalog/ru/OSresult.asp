...
<table cellpadding="0" cellspacing="0" border="0">
	...
	<tr><td class="8pt sys-font-body sys-color-body" valign="top">
			<b>В результате поиска получено  <span id="totalitems"></span>&nbsp; результатов</b> <br/>Чтобы просмотреть обновления, найденные для каждой категории, выберите категорию из списка ниже.</td>
	</tr>
	...
	<tr><td id="info" class="8pt sys-font-body sys-color-body" align="center" valign="bottom">
		<img src="/catalog/images/ts.gif" width="1" height="100"><b>Выберите категорию из списка выше.</b></td>
	</tr>
	...
	<tr><td id="gotobasket" class="8pt sys-font-body sys-color-body" align="left" valign="top" style="visibility:hidden">
		<table cellpadding="0" cellspacing="0" border="0" width="100%">
			...
			<tr>
				<td class="8pt sys-font-body sys-color-body" valign="top" width="50%"><a class="sys-link-normal" href="/" onclick="javascript:gobasket();return false;"><img alt="Значок с зеленой стрелкой, обозначающий задачу или действие." src="/catalog/images/green_arrow.gif" border="0"  style="padding-bottom:-5px;" align=absmiddle WIDTH="30" HEIGHT="25">Переход к корзине загрузки</a></td>
				<td class="8pt sys-font-body sys-color-body" align="right">Всего элементов в корзине загрузки:<span id="eViewBasket"> </span> <span id="eBasketStats"></span> </td>
			</tr>
			<tr>
				<td colspan="2" HEIGHT="6"><img src="/catalog/images/ts.gif" HEIGHT="10"></td>
			</tr>
			<tr>
				<td colspan="2" class="8pt sys-font-body sys-color-body" valign="top" align='right'>Упорядочить по: 
					<select onchange="sortitems()" name="sortselect" id="sortselect">
						<option value="0">Название</option>
						<option value="2">Дата выпуска</option>
					</select>
				</td>
