...
function Docheck(){
	...
	if (selected == 0){
		alert("Выберите хотя бы один тип обновления.");
		return false;
	}
	else{
...
<table cellpadding="0" cellspacing="0" border="0">
	...
	<tr><td class="8pt sys-font-body sys-color-body">Поиск обновлений для операционных систем семейства Windows. Выберите критерии из списка ниже, затем нажмите кнопку <b>Поиск</b>.</td></tr>
		...
		<table cellpadding="0" cellspacing="0" leftmargin="0" height="100%" class="tblborder sys-table-color-border sys-table-cell-bgcolor2" border="0">
			<tr><td>
				<table cellpadding="0" cellspacing="0" border="0" class="innertbl" height="100%" >
					...
					<tr><td class="8pt sys-font-body sys-color-body">Операционная система:</td></tr>
...
<option value='ver_platform_win32_nt.5.2.amd64.ver_nt_workstation..3790..'><pre>Windows XP x64 Edition Family</pre></option>
					...
					<tr><td class="8pt sys-font-body sys-color-body">Язык: </td></tr>
					...
					<tr>
						...
						<!--	<select NAME="selLanguage" ID="selLanguage">								<option VALUE="ar|1256">Арабский</option>								<option VALUE="en_arabic|1252">С поддержкой арабского</option>								<option VALUE="zhcn|936">Китайский (упрощенное письмо) </option>								<option VALUE="zhtw|950">Китайский (традиционное письмо) </option>								<option VALUE="cs|1250">Чешский</option>								<option VALUE="da|1252">Датский</option>								<option VALUE="nl|1252">Голландский</option>								<option VALUE="en|1252" selected>Английский</option>								<option VALUE="fi|1252">Финский</option>								<option VALUE="fr|1252">Французский</option>								<option VALUE="de|1252">Немецкий</option>								<option VALUE="el|1253">Греческий</option>								<option VALUE="el_ibm|869">Греческий (IBM)</option>								<option VALUE="he|1255">Иврит</option>								<option VALUE="en_hebrew|1252">С поддержкой иврита</option>								<option VALUE="hu|1250">Венгерский</option>								<option VALUE="it|1252">Итальянский</option>								<option VALUE="ja|932">Японский</option>								<option VALUE="nec|932">Японский (NEC)</option>								<option VALUE="ko|949">Корейский</option>								<option VALUE="no|1252">Норвежский</option>								<option VALUE="pl|1250">Польский</option>								<option VALUE="ptbr|1252">Португальский (Бразилия)</option>								<option VALUE="pt|1252">Португальский (стандартный)</option>								<option VALUE="ru|1251">Русский</option>								<option VALUE="sk|1250">Словацкий</option>								<option VALUE="sl|1250">Словенский</option>								<option VALUE="es|1252">Испанский</option>								<option VALUE="sv|1252">Шведский</option>								<option VALUE="en_thai|1252">С поддержкой тайского</option>								<option VALUE="tr|1254">Турецкий</option>							</select>-->
						</td>
					</tr>
					<tr><td class="8pt sys-font-body sys-color-body" height="10em"></td></tr>
					<tr><td valign="top"> <a onclick="showadv();return false;" class="10pt sys-font-heading4 sys-link-normal" href="/" onmouseOver="overchangeimage();" onmouseOut="outchangeimage();">Дополнительные параметры поиска <span id="exco" name="exco"><img id="expando" name="expando" src="/catalog/images/expando_primary_down_normal.gif"></span></a>
					<tr><td class="8pt sys-font-body sys-color-body" height="10em"></td></tr>
					<tr><td>
						<span id="advopt" name="advopt" class="advspan sys-table-color-border sys-rhp-bgcolor sys-table-cell-bgcolor1" style="display:none">
							<table CELLPADDING="0" CELLSPACING="0" BORDER="0" style="padding-left:5px;padding-right:5px">
								<tr><td class="8pt sys-font-body sys-color-body">Дата размещения на веб-узле:</td></tr>
								<tr><td height="2"><img src="/catalog/images/ts.gif" HEIGHT="2" WIDTH="1"></td></tr>
								<tr>
									<td class="8pt sys-font-body sys-color-body">
										<select NAME="selPostedDate" ID="selPostedDate">
											...
											<option value="14">2 прошлых недели</option>
											<option value="30">Прошлый месяц</option>
											<option value="60">2 прошлых месяца</option>
											<option value="180">Прошлое полугодие</option>
											<option value="365">Прошлый год</option>
										</select>
									</td>
								</tr>
								<tr><td height="10em"></td></tr>
								<tr><td class="8pt sys-font-body sys-color-body"><nobr>Содержит слова:&nbsp;&nbsp;
																<a class="sys-link-normal" href="javascript:goLearnKeywords()">Подробнее об использовании слов для ограничения поиска</a></nobr></td></tr>
								<tr><td height="2"><img src="/catalog/images/ts.gif" HEIGHT="2" WIDTH="1"></td></tr>
								<tr>
									<td class="8pt sys-font-body sys-color-body">
								...
								<tr><td height="10em"></td></tr>
								<tr><td class="8pt sys-font-body sys-color-body">Типы обновлений:</td></tr>
								<tr><td class="8pt sys-font-body sys-color-body">
										<table width="100%">
											<tr>
											
														</tr><tr>
													<td class=8pt sys-font-body sys-color-body valign=top><table><tr><td width="20" valign=top><INPUT type=checkbox id=check0 name=check0 value='Critical Updates' checked></td><td class=8pt sys-font-body sys-color-body ><label for=check0>&#1050;&#1083;&#1102;&#1095;&#1077;&#1074;&#1099;&#1077; &#1086;&#1073;&#1085;&#1086;&#1074;&#1083;&#1077;&#1085;&#1080;&#1103; &#1080; &#1087;&#1072;&#1082;&#1077;&#1090;&#1099; &#1086;&#1073;&#1085;&#1086;&#1074;&#1083;&#1077;&#1085;&#1080;&#1103;</label></td></tr></table></td><td class=8pt sys-font-body sys-color-body valign=top><table><tr><td width="20" valign=top><INPUT type=checkbox id=check1 name=check1 value='Advanced Security Updates' checked></td><td class=8pt sys-font-body sys-color-body ><label for=check1>&#1044;&#1086;&#1087;&#1086;&#1083;&#1085;&#1080;&#1090;&#1077;&#1083;&#1100;&#1085;&#1099;&#1077; &#1086;&#1073;&#1085;&#1086;&#1074;&#1083;&#1077;&#1085;&#1080;&#1103; &#1089;&#1080;&#1089;&#1090;&#1077;&#1084;&#1099; &#1073;&#1077;&#1079;&#1086;&#1087;&#1072;&#1089;&#1085;&#1086;&#1089;&#1090;&#1080;</label></td></tr></table></td>
														</tr><tr>
													<td class=8pt sys-font-body sys-color-body valign=top><table><tr><td width="20" valign=top><INPUT type=checkbox id=check2 name=check2 value='Internet and Multimedia Updates' checked></td><td class=8pt sys-font-body sys-color-body ><label for=check2>&#1054;&#1073;&#1085;&#1086;&#1074;&#1083;&#1077;&#1085;&#1080;&#1103; &#1076;&#1083;&#1103; &#1088;&#1072;&#1073;&#1086;&#1090;&#1099; &#1089; &#1048;&#1085;&#1090;&#1077;&#1088;&#1085;&#1077;&#1090;&#1086;&#1084; &#1080; &#1084;&#1091;&#1083;&#1100;&#1090;&#1080;&#1084;&#1077;&#1076;&#1080;&#1072;</label></td></tr></table></td><td class=8pt sys-font-body sys-color-body valign=top><table><tr><td width="20" valign=top><INPUT type=checkbox id=check3 name=check3 value='Multi-Language Features' checked></td><td class=8pt sys-font-body sys-color-body ><label for=check3>&#1057;&#1088;&#1077;&#1076;&#1089;&#1090;&#1074;&#1072; &#1084;&#1085;&#1086;&#1075;&#1086;&#1103;&#1079;&#1099;&#1095;&#1085;&#1086;&#1081; &#1087;&#1086;&#1076;&#1076;&#1077;&#1088;&#1078;&#1082;&#1080;</label></td></tr></table></td>
														</tr><tr>
													<td class=8pt sys-font-body sys-color-body valign=top><table><tr><td width="20" valign=top><INPUT type=checkbox id=check4 name=check4 value='Recommended Updates' checked></td><td class=8pt sys-font-body sys-color-body ><label for=check4>&#1056;&#1077;&#1082;&#1086;&#1084;&#1077;&#1085;&#1076;&#1091;&#1077;&#1084;&#1099;&#1077; &#1086;&#1073;&#1085;&#1086;&#1074;&#1083;&#1077;&#1085;&#1080;&#1103;</label></td></tr></table></td>
											</tr>
										</table></td>
								</tr>
							</table>
			...
			<tr><td align="right" class="osbutton sys-table-header-bgcolor1">
				...
				<button onclick="javascript:Docheck();" onresize="document.recalc('true')" style="width:expression(buttonspan.offsetWidth + 10)" id="button1" name="button1"><span id="buttonspan" name="buttonspan">Поиск</span></button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
			</tr>
		</table>
