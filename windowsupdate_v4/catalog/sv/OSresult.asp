...
<table cellpadding="0" cellspacing="0" border="0">
	...
	<tr><td class="8pt sys-font-body sys-color-body" valign="top">
			<b>Sökningen gav  <span id="totalitems"></span>&nbsp; träffar</b> <br/>Välj i listan nedan om du vill visa uppdateringarna i varje kategori.</td>
	</tr>
	...
	<tr><td id="info" class="8pt sys-font-body sys-color-body" align="center" valign="bottom">
		<img src="/catalog/images/ts.gif" width="1" height="100"><b>Välj en kategori i listan ovan.</b></td>
	</tr>
	...
	<tr><td id="gotobasket" class="8pt sys-font-body sys-color-body" align="left" valign="top" style="visibility:hidden">
		<table cellpadding="0" cellspacing="0" border="0" width="100%">
			...
			<tr>
				<td class="8pt sys-font-body sys-color-body" valign="top" width="50%"><a class="sys-link-normal" href="/" onclick="javascript:gobasket();return false;"><img alt="Grön pil som markerar en uppgift eller en åtgärd." src="/catalog/images/green_arrow.gif" border="0"  style="padding-bottom:-5px;" align=absmiddle WIDTH="30" HEIGHT="25">Gå till hämtningskorgen</a></td>
				<td class="8pt sys-font-body sys-color-body" align="right">Totalt antal objekt i hämtningskorgen:<span id="eViewBasket"> </span> <span id="eBasketStats"></span> </td>
			</tr>
			<tr>
				<td colspan="2" HEIGHT="6"><img src="/catalog/images/ts.gif" HEIGHT="10"></td>
			</tr>
			<tr>
				<td colspan="2" class="8pt sys-font-body sys-color-body" valign="top" align='right'>Sortera efter:
					<select onchange="sortitems()" name="sortselect" id="sortselect">
						<option value="0">Rubrik</option>
						<option value="2">Anslagsdatum</option>
					</select>
				</td>
