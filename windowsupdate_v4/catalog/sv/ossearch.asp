...
function Docheck(){
	...
	if (selected == 0){
		alert("Välj minst en uppdateringstyp.");
		return false;
	}
	else{
...
<table cellpadding="0" cellspacing="0" border="0">
	...
	<tr><td class="8pt sys-font-body sys-color-body">Sök efter uppdateringar för Windows. Ange villkor nedan och klicka på <b>Sök</b></td></tr>
...
<option value='ver_platform_win32_nt.5.2.amd64.ver_nt_workstation..3790..'><pre>Windows XP x64 Edition Family</pre></option>
					...
					<tr>
						...
						<!--	<select NAME="selLanguage" ID="selLanguage">								<option VALUE="ar|1256">Arabiska</option>								<option VALUE="en_arabic|1252">Arabiska aktiverat</option>								<option VALUE="zhcn|936">Kinesiska (förenklad)</option>								<option VALUE="zhtw|950">Kinesiska (traditionell)</option>								<option VALUE="cs|1250">Tjeckiska</option>								<option VALUE="da|1252">Danska</option>								<option VALUE="nl|1252">Nederländska</option>								<option VALUE="en|1252" selected>Engelska</option>								<option VALUE="fi|1252">Finska</option>								<option VALUE="fr|1252">Franska</option>								<option VALUE="de|1252">Tyska</option>								<option VALUE="el|1253">Grekiska</option>								<option VALUE="el_ibm|869">Grekiska IBM</option>								<option VALUE="he|1255">Hebreiska</option>								<option VALUE="en_hebrew|1252">Hebreiska aktiverat</option>								<option VALUE="hu|1250">Ungerska</option>								<option VALUE="it|1252">Italienska</option>								<option VALUE="ja|932">Japanska</option>								<option VALUE="nec|932">Japanska NEC</option>								<option VALUE="ko|949">Koreanska</option>								<option VALUE="no|1252">Norska</option>								<option VALUE="pl|1250">Polska</option>								<option VALUE="ptbr|1252">Portugisiska (brasiliansk)</option>								<option VALUE="pt|1252">Portugisiska (standard)</option>								<option VALUE="ru|1251">Ryska</option>								<option VALUE="sk|1250">Slovakiska</option>								<option VALUE="sl|1250">Slovenska</option>								<option VALUE="es|1252">Spanska</option>								<option VALUE="sv|1252">Svenska</option>								<option VALUE="en_thai|1252">Thailändska aktiverat</option>								<option VALUE="tr|1254">Turkiska</option>							</select>-->
						</td>
					</tr>
					<tr><td class="8pt sys-font-body sys-color-body" height="10em"></td></tr>
					<tr><td valign="top"> <a onclick="showadv();return false;" class="10pt sys-font-heading4 sys-link-normal" href="/" onmouseOver="overchangeimage();" onmouseOut="outchangeimage();">Avancerade sökalterntiv <span id="exco" name="exco"><img id="expando" name="expando" src="/catalog/images/expando_primary_down_normal.gif"></span></a>
					<tr><td class="8pt sys-font-body sys-color-body" height="10em"></td></tr>
					<tr><td>
						<span id="advopt" name="advopt" class="advspan sys-table-color-border sys-rhp-bgcolor sys-table-cell-bgcolor1" style="display:none">
							<table CELLPADDING="0" CELLSPACING="0" BORDER="0" style="padding-left:5px;padding-right:5px">
								...
								<tr>
									<td class="8pt sys-font-body sys-color-body">
										<select NAME="selPostedDate" ID="selPostedDate">
											...
											<option value="60">Senaste 2 månaderna</option>
								...
								<tr><td class="8pt sys-font-body sys-color-body"><nobr>Innehåller orden:&nbsp;&nbsp;
																<a class="sys-link-normal" href="javascript:goLearnKeywords()">Visa mer om hur jag använder ord för att avgränsa sökningen</a></nobr></td></tr>
								<tr><td height="2"><img src="/catalog/images/ts.gif" HEIGHT="2" WIDTH="1"></td></tr>
								<tr>
									<td class="8pt sys-font-body sys-color-body">
								...
								<tr><td height="10em"></td></tr>
								<tr><td class="8pt sys-font-body sys-color-body">Uppdateringstyper:</td></tr>
								<tr><td class="8pt sys-font-body sys-color-body">
										<table width="100%">
											<tr>
											
														</tr><tr>
													<td class=8pt sys-font-body sys-color-body valign=top><table><tr><td width="20" valign=top><INPUT type=checkbox id=check0 name=check0 value='Critical Updates' checked></td><td class=8pt sys-font-body sys-color-body ><label for=check0>Viktiga uppdateringar och Service Pack-versioner</label></td></tr></table></td><td class=8pt sys-font-body sys-color-body valign=top><table><tr><td width="20" valign=top><INPUT type=checkbox id=check1 name=check1 value='Advanced Security Updates' checked></td><td class=8pt sys-font-body sys-color-body ><label for=check1>Avancerade s&#228;kerhetsuppdateringar</label></td></tr></table></td>
														</tr><tr>
													<td class=8pt sys-font-body sys-color-body valign=top><table><tr><td width="20" valign=top><INPUT type=checkbox id=check2 name=check2 value='Internet and Multimedia Updates' checked></td><td class=8pt sys-font-body sys-color-body ><label for=check2>Internet- och multimedieuppdateringar</label></td></tr></table></td><td class=8pt sys-font-body sys-color-body valign=top><table><tr><td width="20" valign=top><INPUT type=checkbox id=check3 name=check3 value='Multi-Language Features' checked></td><td class=8pt sys-font-body sys-color-body ><label for=check3>Flerspr&#229;ksfunktioner</label></td></tr></table></td>
														</tr><tr>
													<td class=8pt sys-font-body sys-color-body valign=top><table><tr><td width="20" valign=top><INPUT type=checkbox id=check4 name=check4 value='Recommended Updates' checked></td><td class=8pt sys-font-body sys-color-body ><label for=check4>Rekommenderade uppdateringar</label></td></tr></table></td>
											</tr>
										</table></td>
								</tr>
							</table>
			...
			<tr><td align="right" class="osbutton sys-table-header-bgcolor1">
				...
				<button onclick="javascript:Docheck();" onresize="document.recalc('true')" style="width:expression(buttonspan.offsetWidth + 10)" id="button1" name="button1"><span id="buttonspan" name="buttonspan">Sök</span></button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
			</tr>
		</table>
		<input type="hidden" name="lan" id="lan" value="sv">
