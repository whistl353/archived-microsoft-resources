...
<table cellpadding="0" cellspacing="0" border="0">
	...
	<tr><td class="8pt sys-font-body sys-color-body" valign="top">
			<b>您的搜索返回了  <span id="totalitems"></span>&nbsp; 结果</b> <br/>从下面的列表中选择来查看在每个目录中找到的更新。</td>
	</tr>
	...
	<tr><td id="info" class="8pt sys-font-body sys-color-body" align="center" valign="bottom">
		<img src="/catalog/images/ts.gif" width="1" height="100"><b>请从上面的列表中选择一个目录。</b></td>
	</tr>
