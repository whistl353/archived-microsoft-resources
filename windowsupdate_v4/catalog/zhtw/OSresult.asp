...
<table cellpadding="0" cellspacing="0" border="0">
	...
	<tr><td class="8pt sys-font-body sys-color-body" valign="top">
			<b>您的搜尋傳回 <span id="totalitems"></span>&nbsp; 個結果</b> <br/>從以下清單選取以查看每一類別目錄中找到的更新。</td>
	</tr>
	...
	<tr><td id="info" class="8pt sys-font-body sys-color-body" align="center" valign="bottom">
		<img src="/catalog/images/ts.gif" width="1" height="100"><b>請從上述清單中選取一個類別目錄。</b></td>
	</tr>
	...
	<tr><td id="gotobasket" class="8pt sys-font-body sys-color-body" align="left" valign="top" style="visibility:hidden">
		<table cellpadding="0" cellspacing="0" border="0" width="100%">
			...
			<tr>
				<td class="8pt sys-font-body sys-color-body" valign="top" width="50%"><a class="sys-link-normal" href="/" onclick="javascript:gobasket();return false;"><img alt="綠色箭號圖示表示一項工作或動作。" src="/catalog/images/green_arrow.gif" border="0"  style="padding-bottom:-5px;" align=absmiddle WIDTH="30" HEIGHT="25">到 [下載籃]</a></td>
				<td class="8pt sys-font-body sys-color-body" align="right">[下載籃] 的項目總數:<span id="eViewBasket"> </span> <span id="eBasketStats"></span> </td>
			</tr>
			<tr>
				<td colspan="2" HEIGHT="6"><img src="/catalog/images/ts.gif" HEIGHT="10"></td>
			</tr>
			<tr>
				<td colspan="2" class="8pt sys-font-body sys-color-body" valign="top" align='right'>排序方式: 
					<select onchange="sortitems()" name="sortselect" id="sortselect">
						<option value="0">標題:</option>
						<option value="2">張貼日期</option>
					</select>
				</td>
