...
<html dir="ltr">
	...
	<body onload="if(self != top && 'function' ==  typeof(fnInit)) fnInit(0, 0);">
		<img src="/shared/images/info_icon.gif" class="icon32" alt="Important information." /><span class="sys-font-heading3 sys-rhp-color-title">Windows Update Error</span><br /><br />
		<div class="error">
Windows Update has encountered an error and cannot display the requested page.<br /><br />
Select from any of the following pages for information about Windows Update services, or <a href="mailto:winupsup@microsoft.com?Subject=Windows Update Feedback" target="_blank" class="sys-link-normal">send us your feedback</a>.<br /><br />
...
<a href="default.asp?page=support.asp" target="_parent" class="sys-link-normal">Support Information</a><br />
