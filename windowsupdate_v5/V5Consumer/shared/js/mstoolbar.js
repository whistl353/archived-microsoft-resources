...
function fnFadeMenu(){
	...
	if(g_oLastMenuDivStyle != null){
		...
		bInsideToolbar = ((iCursorLeft > eMSMenuPane.offsetLeft + 26) && (iCursorLeft < document.body.offsetWidth - 12) && (iCursorTop > 15));
		bInsideMenu = ((iCursorLeft - 2  > g_iMenuLeft) && (iCursorLeft < g_iMenuRight) && (iCursorTop < g_iMenuBottom));
