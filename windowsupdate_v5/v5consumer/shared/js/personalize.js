...
function fnGetLanID(sLanID){
	var sAllSupported = "ar,cs,da,de,el,en,es,fi,fr,he,hu,it,ja,ko,nl,no,pt,ru,sv,tr,";
	switch(sLanID)
	{
		case "en":
		case "en-us":
...
function fnWriteLanguages(){
	...
	var sLanID ="ar,zh-cn,zh-tw,zh-hk,cs,da,nl,en,fi,fr,de,el,he,hu,it,ja,ko,no,pl,pt-br,pt,ru,es,sv,tr";
