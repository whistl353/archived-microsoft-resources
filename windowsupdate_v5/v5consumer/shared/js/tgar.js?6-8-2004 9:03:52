...
function fnPingServer(pArr,sPingBackUrl){
	//var TG = '<LAYER visibility="hide"><div style="display:none;"><IMG src="' + window.location.protocol + sPingBackUrl ;
	...
	if ("object" == typeof(eReporting))eReporting.location.replace(TG); //Bypass history
