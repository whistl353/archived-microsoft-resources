...
<link rel='stylesheet' type='text/css' href='shared/css/content.css' />
	...
	<body onload="fnInit(3, 10);" bgcolor="white" link="#587EDC" alink="#587EDC" vlink="#587EDC">
	
		<font face="Tahoma, Arial, Helvetica">

			<font size="3" color="#587EDC"><b>Thank you for your interest in Windows Update</b></font><br /><br />
			Windows Update is the online extension of Microsoft Windows that helps you get the most out of your computer.<br /><br />
			<font size="2">
				Follow these steps to access Windows Update through the Help and support Center:
				<ul>
					<li>Click <b>Start</b>, and then click <b>Help and support</b>.</li>
					<li>If you are running Windows XP, click <b>Keep your computer up-to-date with Windows Update</b>.</li>
					<li>If you are running a Windows Server 2003 family product, click <b>Windows Update</b>.</li>
				</ul>
			</font>
