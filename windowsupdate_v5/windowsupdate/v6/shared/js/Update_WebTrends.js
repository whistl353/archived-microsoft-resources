var gTagVer = "Update 1.5/05-25-06";
var gService = true;
var gTimeZone = 0;
function dcsCookie(){
...
if(document.all){var title=e.innerText||e.innerHTML||"";}else{var title=e.text||e.innerHTML||"";}
dcsMultiTrack("DCS.dcssip",e.hostname,"DCS.dcsuri",path,"DCS.dcsqry",e.search||"","WT.ti","Link:"+title,"WT.dl","1","WT.ad","","WT.mc_id","","WT.sp","");
DCS.dcssip=DCS.dcsuri=DCS.dcsqry=WT.ti=WT.dl=title="";
}
}
}
}
...
title=e.form.id||e.form.className||e.form.name||"Unknown";
method=e.form.method||"Unknown";
}
else{
uri=window.location.pathname;
title=e.name||e.id||"Unknown";
method="Input";
}
if((uri!="")&&(title!="")&&(method!="")&&(evt.keyCode!=9)){
dcsMultiTrack("DCS.dcsuri",uri,"DCS.dcsqry",qry,"WT.ti","FormButton:"+title,"WT.dl","2","WT.fm",method,"WT.ad","","WT.mc_id","","WT.sp","");
}
DCS.dcsuri=DCS.dcsqry=qry=WT.ti=WT.dl=WT.fm="";
}
}
}
